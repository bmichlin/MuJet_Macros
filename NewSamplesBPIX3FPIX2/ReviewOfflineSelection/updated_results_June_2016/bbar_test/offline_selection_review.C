...
//ExtFidCut_UnHardCodeCuts_SampleList.txt
	...
	readTextFileWithSamples("/fdata/hepx/store/user/bmichlin/ExtFidCut_UnHardCodeCuts_bbar.txt", DarkSUSY_mH_125_mGammaD_v);
	//readTextFileWithSamples("/fdata/hepx/store/user/bmichlin/ExtFidCut_UnHardCodeCuts_SampleList.txt", DarkSUSY_mH_125_mGammaD_v);
	for(auto v: DarkSUSY_mH_125_mGammaD_v) offline_vs_signal(v, 0);
