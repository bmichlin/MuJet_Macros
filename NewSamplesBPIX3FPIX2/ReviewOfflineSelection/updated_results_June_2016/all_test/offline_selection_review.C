...
//Background:
	std::vector< std::vector<string> > DarkSUSY_mH_125_mGammaD_vbbar;
	readTextFileWithSamples("/fdata/hepx/store/user/bmichlin/ExtFidCut_UnHardCodeCuts_bbar.txt", DarkSUSY_mH_125_mGammaD_vbbar);
	for(auto v: DarkSUSY_mH_125_mGammaD_vbbar) offline_vs_signal(v, 0);
	makePlots();
