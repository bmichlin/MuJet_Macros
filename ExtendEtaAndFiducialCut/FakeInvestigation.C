	...
	while ((chEl=(TChainElement*)next())) {
		...
		for(int k=0;k<t->GetEntries();k++){
			...
			if(is4GenMu8){
				...
				//if(fabs(dphi_gD)>=2.5){
				if(fabs(genA0_Lxy)<10.2 && fabs(genA1_Lxy)<10.2 && fabs(genA0_Lz)<48.5 && fabs(genA1_Lz)<48.5){
					ev_4gmlxylzcut++;
				}
				//}
			}
			...
			if(triggerFlag_std > 0 && triggerFlag_lxy == 0){
				...
				if(fabs(genA0_Lxy)>=11.0 || fabs(genA0_Lz)>=48.5 || fabs(genA1_Lxy)>=11.0 || fabs(genA1_Lz)>=48.5 ){ //We only want to perform this loop on a very pure sample of fakes.  Set to 11.0 instead of 10.2. 
					//Now match 
					//cout << "" << endl;
					...
					if(MatchRECOtoGENdimuons(diMuonC_FittedVtx_eta, diMuonC_FittedVtx_phi, diMuonF_FittedVtx_eta, diMuonF_FittedVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
						if(fabs(genA0_Lxy)>=11.0 || fabs(genA0_Lz)>=48.5){ //A0 is the fake and has match diMuonC
						...
						if(fabs(genA1_Lxy)>=11.0 || fabs(genA1_Lz)>=48.5){ //A1 is the fake and has match diMuonF
							//NOW LOOK AT INDIVIDUAL MUONS
							//{{{                                        
						...
						if(fabs(genA0_Lxy)>=11.0 || fabs(genA0_Lz)>=48.5){ //A0 is the fake and has match diMuonF
							//NOW LOOK AT INDIVIDUAL MUONS
							//{{{                                        
							//HERE, we know that DIMUONF is bad
							//DIMUONF contains RECO muons reco_real_muons_phi[diMuonF_match0] and reco_real_muons_phi[diMuonF_match1]
						...
						if(fabs(genA1_Lxy)>=11.0 || fabs(genA1_Lz)>=48.5){ //A1 is the fake and has match diMuonC
							//NOW LOOK AT INDIVIDUAL MUONS
							//{{{
							//HERE, we know that DIMUONC is bad
							//DIMUONC contains RECO muons reco_real_muons_phi[diMuonC_match0] and reco_real_muons_phi[diMuonC_match1]
				...
				if(fabs(genA0_Lxy >= 10.2) && fabs(genA0_Lz < 48.5)) fakeCounter_dimuon1 = 1; //Fails only Lxy
				if(fabs(genA0_Lxy < 10.2) && fabs(genA0_Lz >= 48.5)) fakeCounter_dimuon1 = 2; //Fails only Lz
				if(fabs(genA0_Lxy >= 10.2) && fabs(genA0_Lz >= 48.5)) fakeCounter_dimuon1 = 3; //Fails both Lxy and Lz
				if(fabs(genA1_Lxy >= 10.2) && fabs(genA1_Lz < 48.5)) fakeCounter_dimuon2 = 4; //Fails only Lxy
				if(fabs(genA1_Lxy < 10.2) && fabs(genA1_Lz >= 48.5)) fakeCounter_dimuon2 = 5; //Fails only Lz
				if(fabs(genA1_Lxy >= 10.2) && fabs(genA1_Lz >= 48.5)) fakeCounter_dimuon2 = 6; //Fails both Lxy and Lz
...
//Ben's 0.25 GeV sample with ability to extend fiducial cut AND no barrel muon requirement (|eta| < 2.4 for all mu)
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_000_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_000_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/"); 
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_005_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_005_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_010_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_010_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_020_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_020_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_050_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_050_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_100_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_100_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_200_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_200_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_300_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_300_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_500_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_500_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_1000_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_1000_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
efficiency_hitrecovery("/fdata/hepx/store/user/bmichlin/DarkSUSY_mH_125_mGammaD_0250_cT_2000_Evt_80k_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1/DarkSUSY_mH_125_mGammaD_0250_cT_2000_Evt_80k_PATANA_ExtendFidCutAndEta_v1/Combined/");
