...
//Phi residuals
TH1F *Uncuttable_Fake_dimuon1_PhiResidual = new TH1F("Uncuttable_Fake_dimuon1_PhiResidual", "Uncuttable_Fake_dimuon1_PhiResidual", 600, -6, 6);
TH1F *Uncuttable_Fake_dimuon2_PhiResidual = new TH1F("Uncuttable_Fake_dimuon2_PhiResidual", "Uncuttable_Fake_dimuon2_PhiResidual", 600, -6, 6);
TH1F *Real_dimuon1_PhiResidual = new TH1F("Real_dimuon1_PhiResidual", "Real_dimuon1_PhiResidual", 600, -6, 6);
TH1F *Real_dimuon2_PhiResidual = new TH1F("Real_dimuon2_PhiResidual", "Real_dimuon2_PhiResidual", 600, -6, 6);

TH2F *Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi = new TH2F("Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi", "Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi = new TH2F("Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi", "Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi",400, -4, 4, 600, -6, 6);
TH2F *Real_dimuon1_PhiResidual_vs_Phi = new TH2F("Real_dimuon1_PhiResidual_vs_Phi", "Real_dimuon1_PhiResidual_vs_Phi",400, -4, 4, 600, -6, 6);
TH2F *Real_dimuon2_PhiResidual_vs_Phi = new TH2F("Real_dimuon2_PhiResidual_vs_Phi", "Real_dimuon2_PhiResidual_vs_Phi",400, -4, 4, 600, -6, 6);


TH2F *Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy", "Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy", 150, 0, 30, 600, -6, 6);
TH2F *Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy", "Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy",150, 0, 30, 600, -6, 6);


TH2F *Real_dimuon1_PhiResidual_vs_Lxy = new TH2F("Real_dimuon1_PhiResidual_vs_Lxy", "Real_dimuon1_PhiResidual_vs_Lxy",150, 0, 30, 600, -6, 6);
TH2F *Real_dimuon2_PhiResidual_vs_Lxy = new TH2F("Real_dimuon2_PhiResidual_vs_Lxy", "Real_dimuon2_PhiResidual_vs_Lxy",150, 0, 30, 600, -6, 6);
...
TH1F *Real_Muon_00_Phi_Residual = new TH1F("Real_Muon_00_Phi_Residual", "Real_Muon_00_Phi_Residual", 600, -6, 6);
TH1F *Real_Muon_01_Phi_Residual = new TH1F("Real_Muon_01_Phi_Residual", "Real_Muon_01_Phi_Residual", 600, -6, 6);
TH1F *Real_Muon_10_Phi_Residual = new TH1F("Real_Muon_10_Phi_Residual", "Real_Muon_10_Phi_Residual", 600, -6, 6);
TH1F *Real_Muon_11_Phi_Residual = new TH1F("Real_Muon_11_Phi_Residual", "Real_Muon_11_Phi_Residual", 600, -6, 6);

TH1F *Uncuttable_Fake_Muon_00_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_00_Phi_Residual", "Uncuttable_Fake_Muon_00_Phi_Residual", 600, -6, 6);
TH1F *Uncuttable_Fake_Muon_01_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_01_Phi_Residual", "Uncuttable_Fake_Muon_01_Phi_Residual", 600, -6, 6);
TH1F *Uncuttable_Fake_Muon_10_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_10_Phi_Residual", "Uncuttable_Fake_Muon_10_Phi_Residual", 600, -6, 6);
TH1F *Uncuttable_Fake_Muon_11_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_11_Phi_Residual", "Uncuttable_Fake_Muon_11_Phi_Residual", 600, -6, 6);
...
TH2F *Real_Muon_00_Phi_Residual_vs_Phi = new TH2F("Real_Muon_00_Phi_Residual_vs_Phi", "Real_Muon_00_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Real_Muon_01_Phi_Residual_vs_Phi = new TH2F("Real_Muon_01_Phi_Residual_vs_Phi", "Real_Muon_01_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Real_Muon_10_Phi_Residual_vs_Phi = new TH2F("Real_Muon_10_Phi_Residual_vs_Phi", "Real_Muon_10_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Real_Muon_11_Phi_Residual_vs_Phi = new TH2F("Real_Muon_11_Phi_Residual_vs_Phi", "Real_Muon_11_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);

TH2F *Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
TH2F *Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi", 400, -4, 4, 600, -6, 6);
...
TH1F *Real_Dimuon_Opening_Angle_Residual = new TH1F("Real_Dimuon_Opening_Angle_Residual", "Real_Dimuon_Opening_Angle_Residual", 600, -6, 6);
TH2F *Real_Dimuon_opening_Angle_Residual_vs_GENangle = new TH2F("Real_Dimuon_opening_Angle_Residual_vs_GENangle", "Real_Dimuon_opening_Angle_Residual_vs_GENangle", 400, -4, 4, 600, -6, 6);
...
TH1F *UncuttableFake1_Dimuon_Opening_Angle_Residual = new TH1F("UncuttableFake1_Dimuon_Opening_Angle_Residual", "UncuttableFake1_Dimuon_Opening_Angle_Residual", 600, -6, 6);
TH2F *UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle = new TH2F("UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle", "UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle", 400, -4, 4, 600, -6, 6);
...
TH1F *UncuttableFake2_Dimuon_Opening_Angle_Residual = new TH1F("UncuttableFake2_Dimuon_Opening_Angle_Residual", "UncuttableFake2_Dimuon_Opening_Angle_Residual", 600, -6, 6);
TH2F *UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle = new TH2F("UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle", "UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle", 400, -4, 4, 600, -6, 6);
...
void makePlotsPretty(){
	...
	Real_Dimuon_opening_Angle_Residual_vs_GENangle->GetXaxis()->SetTitle("Residual #delta#phi Between Dimuon (#delta#phi_{GEN}-#delta#phi_{RECO}) [rads]");
	Real_Dimuon_opening_Angle_Residual_vs_GENangle->GetYaxis()->SetTitle("GEN #delta#phi [rads]");
	...
	UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle->GetXaxis()->SetTitle("Residual #delta#phi Between Dimuon (#delta#phi_{GEN}-#delta#phi_{RECO}) [rads]");
	UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle->GetYaxis()->SetTitle("GEN #delta#phi [rads]");
	...
	UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle->GetXaxis()->SetTitle("Residual #delta#phi Between Dimuon (#delta#phi_{GEN}-#delta#phi_{RECO}) [rads]");
	UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle->GetYaxis()->SetTitle("GEN #delta#phi [rads]");
	...
	Real_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetXaxis()->SetTitle("Residual #delta R Between Dimuon (#delta R_{GEN}-#delta R_{RECO})");
	Real_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetYaxis()->SetTitle("GEN #delta R");
	...
	UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetXaxis()->SetTitle("Residual #delta R Between Dimuon (#delta R_{GEN}-#delta R_{RECO})");
	UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetYaxis()->SetTitle("GEN #delta R");
	...
	UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetXaxis()->SetTitle("Residual #delta R Between Dimuon (#delta R_{GEN}-#delta R_{RECO})");
	UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetYaxis()->SetTitle("GEN #delta R");
