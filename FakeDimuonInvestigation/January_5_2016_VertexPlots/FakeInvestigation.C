...
//Print a few values
			...
			if(triggerFlag_std > 0 && triggerFlag_lxy == 0){
				...
				if(fabs(genA0_Lxy)>=4.4 || fabs(genA0_Lz)>=34.5){
					...
					if(fabs(diMuonC_FittedVtx_Lxy) < 4.4 && fabs( sqrt( (diMuonC_FittedVtx_L*diMuonC_FittedVtx_L) - (diMuonC_FittedVtx_Lxy*diMuonC_FittedVtx_Lxy))  ) < 34.5){
						cout << "" << endl;
						...
						if(diMuonC_FittedVtx_Lxy > -800) Uncuttable_Fake_dimuon1_Reco_Lxy->Fill(diMuonC_FittedVtx_Lxy);
						if(diMuonC_FittedVtx_eta > -800) Uncuttable_Fake_dimuon1_Reco_Eta->Fill(diMuonC_FittedVtx_eta);
						if(diMuonC_FittedVtx_phi > -800) Uncuttable_Fake_dimuon1_Reco_Phi->Fill(diMuonC_FittedVtx_phi);
						if(diMuonC_FittedVtx_px > -800 && diMuonC_FittedVtx_py > -800) Uncuttable_Fake_dimuon1_Reco_pT->Fill(sqrt(diMuonC_FittedVtx_px*diMuonC_FittedVtx_px+diMuonC_FittedVtx_py*diMuonC_FittedVtx_py));
						if(diMuonC_FittedVtx_m > -800) Uncuttable_Fake_dimuon1_Reco_MassCompatability->Fill(diMuonC_FittedVtx_m,diMuonF_FittedVtx_m);
						...
						if(MatchRECOtoGENdimuons(diMuonC_FittedVtx_eta, diMuonC_FittedVtx_phi, diMuonF_FittedVtx_eta, diMuonF_FittedVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
							//eta
							Uncuttable_Fake_dimuon1_EtaResidual->Fill(genA0_eta - diMuonC_FittedVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonC_FittedVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonC_FittedVtx_eta);


							//phi
							Uncuttable_Fake_dimuon1_PhiResidual->Fill(genA0_phi - diMuonC_FittedVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonC_FittedVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonC_FittedVtx_phi);


							//Lxy
							Uncuttable_Fake_dimuon1_LxyResidual->Fill(genA0_Lxy - diMuonC_FittedVtx_Lxy);
							Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonC_FittedVtx_Lxy);


							//Vertex
							UncuttableFake1_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
							UncuttableFake1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy));
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonC_FittedVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy), genA0_Lxy - diMuonC_FittedVtx_Lxy);

							UncuttableFake1_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
							UncuttableFake1_RECO_Dimuon_vertex_z->Fill(diMuonC_FittedVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonC_FittedVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonC_FittedVtx_vz);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonC_FittedVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_FittedVtx_vz, genA0_Lxy - diMuonC_FittedVtx_Lxy);



						}else{ //diMuonC -> A1, diMuonF -> A0
							//eta
							Uncuttable_Fake_dimuon1_EtaResidual->Fill(genA1_eta - diMuonC_FittedVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonC_FittedVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonC_FittedVtx_eta);

							//phi

							Uncuttable_Fake_dimuon1_PhiResidual->Fill(genA1_phi - diMuonC_FittedVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonC_FittedVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonC_FittedVtx_phi);

							//Lxy

							Uncuttable_Fake_dimuon1_LxyResidual->Fill(genA1_Lxy - diMuonC_FittedVtx_Lxy);
							Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonC_FittedVtx_Lxy);

							//Vertex
							UncuttableFake1_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
							UncuttableFake1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy));
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonC_FittedVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_FittedVtx_vx*diMuonC_FittedVtx_vx + diMuonC_FittedVtx_vy*diMuonC_FittedVtx_vy), genA1_Lxy - diMuonC_FittedVtx_Lxy);

							UncuttableFake1_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
							UncuttableFake1_RECO_Dimuon_vertex_z->Fill(diMuonC_FittedVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonC_FittedVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonC_FittedVtx_vz);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonC_FittedVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_FittedVtx_vz, genA1_Lxy - diMuonC_FittedVtx_Lxy);
						}
						...
						UncuttableFake1_RECO_Dimuon_Opening_Angle->Fill(My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi));
						UncuttableFake1_Dimuon_Opening_Angle_Residual->Fill(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi));
						UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle->Fill(My_dPhi(genA0_phi,genA1_phi), My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi));
				...
				*/
					...
					if(fabs(diMuonF_FittedVtx_Lxy) < 4.4 && fabs( sqrt( (diMuonF_FittedVtx_L*diMuonF_FittedVtx_L) - (diMuonF_FittedVtx_Lxy*diMuonF_FittedVtx_Lxy))  ) < 34.5){ 
						...
						if(diMuonF_FittedVtx_Lxy > -800) Uncuttable_Fake_dimuon2_Reco_Lxy->Fill(diMuonF_FittedVtx_Lxy);
						if(diMuonF_FittedVtx_eta > -800) Uncuttable_Fake_dimuon2_Reco_Eta->Fill(diMuonF_FittedVtx_eta);
						if(diMuonF_FittedVtx_phi > -800) Uncuttable_Fake_dimuon2_Reco_Phi->Fill(diMuonF_FittedVtx_phi);
						if(diMuonF_FittedVtx_px > -800 && diMuonF_FittedVtx_py > -800) Uncuttable_Fake_dimuon2_Reco_pT->Fill(sqrt(diMuonF_FittedVtx_px*diMuonF_FittedVtx_px+diMuonF_FittedVtx_py*diMuonF_FittedVtx_py));
						...
						if(MatchRECOtoGENdimuons(diMuonC_FittedVtx_eta, diMuonC_FittedVtx_phi, diMuonF_FittedVtx_eta, diMuonF_FittedVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
							...
							Uncuttable_Fake_dimuon2_EtaResidual->Fill(genA1_eta - diMuonF_FittedVtx_eta);
							Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonF_FittedVtx_eta);
							Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonF_FittedVtx_eta);

							//phi

							Uncuttable_Fake_dimuon2_PhiResidual->Fill(genA1_phi - diMuonF_FittedVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonF_FittedVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonF_FittedVtx_phi);

							//Lxy

							Uncuttable_Fake_dimuon2_LxyResidual->Fill(genA1_Lxy - diMuonF_FittedVtx_Lxy);
							Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonF_FittedVtx_Lxy);

//vertex
							UncuttableFake2_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
							UncuttableFake2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy));
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonF_FittedVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy), genA1_Lxy - diMuonF_FittedVtx_Lxy);

							UncuttableFake2_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
							UncuttableFake2_RECO_Dimuon_vertex_z->Fill(diMuonF_FittedVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonF_FittedVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonF_FittedVtx_vz);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonF_FittedVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_FittedVtx_vz, genA1_Lxy - diMuonF_FittedVtx_Lxy);

						}else{ //diMuonC -> A1, diMuonF -> A0
							//eta
							Uncuttable_Fake_dimuon2_EtaResidual->Fill(genA0_eta - diMuonF_FittedVtx_eta);
							Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonF_FittedVtx_eta);                                                        

							Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonF_FittedVtx_eta);


							//phi
							Uncuttable_Fake_dimuon2_PhiResidual->Fill(genA0_phi - diMuonF_FittedVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonF_FittedVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonF_FittedVtx_phi);


							//Lxy
							Uncuttable_Fake_dimuon2_LxyResidual->Fill(genA0_Lxy - diMuonF_FittedVtx_Lxy);
							Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonF_FittedVtx_Lxy);

//vertex
							UncuttableFake2_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
							UncuttableFake2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy));
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonF_FittedVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_FittedVtx_vx*diMuonF_FittedVtx_vx + diMuonF_FittedVtx_vy*diMuonF_FittedVtx_vy), genA0_Lxy - diMuonF_FittedVtx_Lxy);

							UncuttableFake2_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
							UncuttableFake2_RECO_Dimuon_vertex_z->Fill(diMuonF_FittedVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonF_FittedVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonF_FittedVtx_vz);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonF_FittedVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_FittedVtx_vz, genA0_Lxy - diMuonF_FittedVtx_Lxy);
						...
						UncuttableFake2_RECO_Dimuon_Opening_Angle->Fill(My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi));
						UncuttableFake2_Dimuon_Opening_Angle_Residual->Fill(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi));
						UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle->Fill(My_dPhi(genA0_phi,genA1_phi), My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi));
						...
						double RECO_deta_forUncut2 = diMuonC_FittedVtx_eta - diMuonF_FittedVtx_eta;
						double RECO_dphi_forUncut2 = My_dPhi(diMuonC_FittedVtx_phi,diMuonF_FittedVtx_phi);
