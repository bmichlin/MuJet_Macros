...
#include <math.h>
//============= Global Variables ===========================//
TFile *BAM = new TFile("erec_alphagen_ConsistentVTX.root","RECREATE");
...
//Uncuttable fakes (ie GEN Lxy > 4.4, RECO Lxy < 4.4)

TH1F *Uncuttable_Fake_dimuon1_Gen_Lxy = new TH1F("Uncuttable_Fake_dimuon1_Gen_Lxy", "Uncuttable_Fake_dimuon1_Gen_Lxy", 400, 0, 80 );
TH1F *Uncuttable_Fake_dimuon1_Gen_Eta = new TH1F("Uncuttable_Fake_dimuon1_Gen_Eta", "Uncuttable_Fake_dimuon1_Gen_Eta", 500, -5, 5);
TH1F *Uncuttable_Fake_dimuon1_Gen_Phi = new TH1F("Uncuttable_Fake_dimuon1_Gen_Phi", "Uncuttable_Fake_dimuon1_Gen_Phi", 340, -3.4, 3.4);
TH1F *Uncuttable_Fake_dimuon1_Gen_pT = new TH1F("Uncuttable_Fake_dimuon1_Gen_pT", "Uncuttable_Fake_dimuon1_Gen_pT", 100, 0, 100);
TH2F *Uncuttable_Fake_dimuon1_Gen_MassCompatability = new TH2F("Uncuttable_Fake_dimuon1_Gen_MassCompatability","Uncuttable_Fake_dimuon1_Gen_MassCompatability", 100, 0, 10, 100, 0, 10);
TH2F *Uncuttable_Fake_dimuon1_Gen_pT_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon1_Gen_pT_vs_Lxy", "Uncuttable_Fake_dimuon1_Gen_pT_vs_Lxy", 100,0,100,400,0,80);
TH1F *Uncuttable_Fake_dimuon1_Gen_Lz = new TH1F("Uncuttable_Fake_dimuon1_Gen_Lz", "Uncuttable_Fake_dimuon1_Gen_Lz", 400, 0, 80 );

TH1F *Uncuttable_Fake_dimuon1_Reco_Lxy = new TH1F("Uncuttable_Fake_dimuon1_Reco_Lxy", "Uncuttable_Fake_dimuon1_Reco_Lxy", 400, 0, 80 );
TH1F *Uncuttable_Fake_dimuon1_Reco_Eta = new TH1F("Uncuttable_Fake_dimuon1_Reco_Eta", "Uncuttable_Fake_dimuon1_Reco_Eta", 500, -5, 5);
TH1F *Uncuttable_Fake_dimuon1_Reco_Phi = new TH1F("Uncuttable_Fake_dimuon1_Reco_Phi", "Uncuttable_Fake_dimuon1_Reco_Phi", 340, -3.4, 3.4);
TH1F *Uncuttable_Fake_dimuon1_Reco_pT = new TH1F("Uncuttable_Fake_dimuon1_Reco_pT", "Uncuttable_Fake_dimuon1_Reco_pT", 100, 0, 100);
TH2F *Uncuttable_Fake_dimuon1_Reco_MassCompatability = new TH2F("Uncuttable_Fake_dimuon1_Reco_MassCompatability","Uncuttable_Fake_dimuon1_Reco_MassCompatability", 100, 0, 10, 100, 0, 10);
TH2F *Uncuttable_Fake_dimuon1_Reco_pT_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon1_Reco_pT_vs_Lxy", "Uncuttable_Fake_dimuon1_Reco_pT_vs_Lxy", 100,0,100,400,0,80);

TH1F *Uncuttable_Fake_dimuon2_Gen_Lxy = new TH1F("Uncuttable_Fake_dimuon2_Gen_Lxy", "Uncuttable_Fake_dimuon2_Gen_Lxy", 400, 0, 80 );
TH1F *Uncuttable_Fake_dimuon2_Gen_Eta = new TH1F("Uncuttable_Fake_dimuon2_Gen_Eta", "Uncuttable_Fake_dimuon2_Gen_Eta", 500, -5, 5);
TH1F *Uncuttable_Fake_dimuon2_Gen_Phi = new TH1F("Uncuttable_Fake_dimuon2_Gen_Phi", "Uncuttable_Fake_dimuon2_Gen_Phi", 340, -3.4, 3.4);
TH1F *Uncuttable_Fake_dimuon2_Gen_pT = new TH1F("Uncuttable_Fake_dimuon2_Gen_pT", "Uncuttable_Fake_dimuon2_Gen_pT", 100, 0, 100);
TH2F *Uncuttable_Fake_dimuon2_Gen_MassCompatability = new TH2F("Uncuttable_Fake_dimuon2_Gen_MassCompatability","Uncuttable_Fake_dimuon2_Gen_MassCompatability", 100, 0, 10, 100, 0, 10);
TH2F *Uncuttable_Fake_dimuon2_Gen_pT_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon2_Gen_pT_vs_Lxy", "Uncuttable_Fake_dimuon2_Gen_pT_vs_Lxy", 100,0,100,400,0,80);
TH1F *Uncuttable_Fake_dimuon2_Gen_Lz = new TH1F("Uncuttable_Fake_dimuon2_Gen_Lz", "Uncuttable_Fake_dimuon2_Gen_Lz", 400, 0, 80 );

TH1F *Uncuttable_Fake_dimuon2_Reco_Lxy = new TH1F("Uncuttable_Fake_dimuon2_Reco_Lxy", "Uncuttable_Fake_dimuon2_Reco_Lxy", 400, 0, 80 );
TH1F *Uncuttable_Fake_dimuon2_Reco_Eta = new TH1F("Uncuttable_Fake_dimuon2_Reco_Eta", "Uncuttable_Fake_dimuon2_Reco_Eta", 500, -5, 5);
TH1F *Uncuttable_Fake_dimuon2_Reco_Phi = new TH1F("Uncuttable_Fake_dimuon2_Reco_Phi", "Uncuttable_Fake_dimuon2_Reco_Phi", 340, -3.4, 3.4);
TH1F *Uncuttable_Fake_dimuon2_Reco_pT = new TH1F("Uncuttable_Fake_dimuon2_Reco_pT", "Uncuttable_Fake_dimuon2_Reco_pT", 100, 0, 100);
TH2F *Uncuttable_Fake_dimuon2_Reco_MassCompatability = new TH2F("Uncuttable_Fake_dimuon2_Reco_MassCompatability","Uncuttable_Fake_dimuon2_Reco_MassCompatability", 100, 0, 10, 100, 0, 10);
TH2F *Uncuttable_Fake_dimuon2_Reco_pT_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon2_Reco_pT_vs_Lxy", "Uncuttable_Fake_dimuon2_Reco_pT_vs_Lxy", 100,0,100,400,0,80);

//Eta residuals
TH1F *Uncuttable_Fake_dimuon1_EtaResidual = new TH1F("Uncuttable_Fake_dimuon1_EtaResidual", "Uncuttable_Fake_dimuon1_EtaResidual", 1000, -10, 10);
TH1F *Uncuttable_Fake_dimuon2_EtaResidual = new TH1F("Uncuttable_Fake_dimuon2_EtaResidual", "Uncuttable_Fake_dimuon2_EtaResidual", 1000, -10, 10);

TH2F *Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta = new TH2F("Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta", "Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta = new TH2F("Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta", "Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta",500, -5, 5, 1000, -10, 10);

TH2F *Real_dimuon1_EtaResidual_vs_Eta = new TH2F("Real_dimuon1_EtaResidual_vs_Eta", "Real_dimuon1_EtaResidual_vs_Eta",500, -5, 5, 1000, -10, 10);
TH2F *Real_dimuon2_EtaResidual_vs_Eta = new TH2F("Real_dimuon2_EtaResidual_vs_Eta", "Real_dimuon2_EtaResidual_vs_Eta",500, -5, 5, 1000, -10, 10);
TH1F *Real_dimuon1_EtaResidual = new TH1F("Real_dimuon1_EtaResidual", "Real_dimuon1_EtaResidual", 1000, -10, 10);
TH1F *Real_dimuon2_EtaResidual = new TH1F("Real_dimuon2_EtaResidual", "Real_dimuon2_EtaResidual", 1000, -10, 10);

TH2F *Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy", "Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy", 150, 0, 30, 1000, -10, 10);
TH2F *Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy", "Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy",150, 0, 30, 1000, -10, 10);

TH2F *Real_dimuon1_EtaResidual_vs_Lxy = new TH2F("Real_dimuon1_EtaResidual_vs_Lxy", "Real_dimuon1_EtaResidual_vs_Lxy",150, 0, 30, 1000, -10, 10);
TH2F *Real_dimuon2_EtaResidual_vs_Lxy = new TH2F("Real_dimuon2_EtaResidual_vs_Lxy", "Real_dimuon2_EtaResidual_vs_Lxy",150, 0, 30, 1000, -10, 10);


//Phi residuals
TH1F *Uncuttable_Fake_dimuon1_PhiResidual = new TH1F("Uncuttable_Fake_dimuon1_PhiResidual", "Uncuttable_Fake_dimuon1_PhiResidual", 700, -7, 7);
TH1F *Uncuttable_Fake_dimuon2_PhiResidual = new TH1F("Uncuttable_Fake_dimuon2_PhiResidual", "Uncuttable_Fake_dimuon2_PhiResidual", 700, -7, 7);
...
TH2F *Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi = new TH2F("Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi", "Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi", 400, -4, 4, 700, -7, 7);
TH2F *Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi = new TH2F("Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi", "Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi",400, -4, 4, 700, -7, 7);
...
TH2F *Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy", "Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy", 150, 0, 30, 700, -7, 7);
TH2F *Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy", "Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy",150, 0, 30, 700, -7, 7);
...
//Lxy residuals
TH1F *Uncuttable_Fake_dimuon1_LxyResidual = new TH1F("Uncuttable_Fake_dimuon1_LxyResidual", "Uncuttable_Fake_dimuon1_LxyResidual", 300, -30, 30);
TH1F *Uncuttable_Fake_dimuon2_LxyResidual = new TH1F("Uncuttable_Fake_dimuon2_LxyResidual", "Uncuttable_Fake_dimuon2_LxyResidual", 300, -30, 30);
...
TH2F *Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy", "Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy", 150, 0, 30, 300, -30, 30);
TH2F *Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy = new TH2F("Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy", "Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy",150, 0, 30, 300, -30, 30);
...
TH1F *Real_Muon_00_Eta_Residual = new TH1F("Real_Muon_00_Eta_Residual", "Real_Muon_00_Eta_Residual", 1000, -10, 10);
TH1F *Real_Muon_01_Eta_Residual = new TH1F("Real_Muon_01_Eta_Residual", "Real_Muon_01_Eta_Residual", 1000, -10, 10);
TH1F *Real_Muon_10_Eta_Residual = new TH1F("Real_Muon_10_Eta_Residual", "Real_Muon_10_Eta_Residual", 1000, -10, 10);
TH1F *Real_Muon_11_Eta_Residual = new TH1F("Real_Muon_11_Eta_Residual", "Real_Muon_11_Eta_Residual", 1000, -10, 10);

TH1F *Uncuttable_Fake_Muon_00_Eta_Residual = new TH1F("Uncuttable_Fake_Muon_00_Eta_Residual", "Uncuttable_Fake_Muon_00_Eta_Residual", 1000, -10, 10);
TH1F *Uncuttable_Fake_Muon_01_Eta_Residual = new TH1F("Uncuttable_Fake_Muon_01_Eta_Residual", "Uncuttable_Fake_Muon_01_Eta_Residual", 1000, -10, 10);
TH1F *Uncuttable_Fake_Muon_10_Eta_Residual = new TH1F("Uncuttable_Fake_Muon_10_Eta_Residual", "Uncuttable_Fake_Muon_10_Eta_Residual", 1000, -10, 10);
TH1F *Uncuttable_Fake_Muon_11_Eta_Residual = new TH1F("Uncuttable_Fake_Muon_11_Eta_Residual", "Uncuttable_Fake_Muon_11_Eta_Residual", 1000, -10, 10);
...
TH1F *Uncuttable_Fake_Muon_00_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_00_Phi_Residual", "Uncuttable_Fake_Muon_00_Phi_Residual", 700, -7, 7);
TH1F *Uncuttable_Fake_Muon_01_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_01_Phi_Residual", "Uncuttable_Fake_Muon_01_Phi_Residual", 700, -7, 7);
TH1F *Uncuttable_Fake_Muon_10_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_10_Phi_Residual", "Uncuttable_Fake_Muon_10_Phi_Residual", 700, -7, 7);
TH1F *Uncuttable_Fake_Muon_11_Phi_Residual = new TH1F("Uncuttable_Fake_Muon_11_Phi_Residual", "Uncuttable_Fake_Muon_11_Phi_Residual", 700, -7, 7);

TH2F *Real_Muon_00_Eta_Residual_vs_Eta = new TH2F("Real_Muon_00_Eta_Residual_vs_Eta", "Real_Muon_00_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Real_Muon_01_Eta_Residual_vs_Eta = new TH2F("Real_Muon_01_Eta_Residual_vs_Eta", "Real_Muon_01_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Real_Muon_10_Eta_Residual_vs_Eta = new TH2F("Real_Muon_10_Eta_Residual_vs_Eta", "Real_Muon_10_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Real_Muon_11_Eta_Residual_vs_Eta = new TH2F("Real_Muon_11_Eta_Residual_vs_Eta", "Real_Muon_11_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);

TH2F *Uncuttable_Fake_Muon_00_Eta_Residual_vs_Eta = new TH2F("Uncuttable_Fake_Muon_00_Eta_Residual_vs_Eta", "Uncuttable_Fake_Muon_00_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Uncuttable_Fake_Muon_01_Eta_Residual_vs_Eta = new TH2F("Uncuttable_Fake_Muon_01_Eta_Residual_vs_Eta", "Uncuttable_Fake_Muon_01_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Uncuttable_Fake_Muon_10_Eta_Residual_vs_Eta = new TH2F("Uncuttable_Fake_Muon_10_Eta_Residual_vs_Eta", "Uncuttable_Fake_Muon_10_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
TH2F *Uncuttable_Fake_Muon_11_Eta_Residual_vs_Eta = new TH2F("Uncuttable_Fake_Muon_11_Eta_Residual_vs_Eta", "Uncuttable_Fake_Muon_11_Eta_Residual_vs_Eta", 500, -5, 5, 1000, -10, 10);
...
TH2F *Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi", 400, -4, 4, 700, -7, 7);
TH2F *Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi", 400, -4, 4, 700, -7, 7);
TH2F *Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi", 400, -4, 4, 700, -7, 7);
TH2F *Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi = new TH2F("Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi", "Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi", 400, -4, 4, 700, -7, 7);


/*
   TH3F *Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta_vs_Lxy = new TH3F("Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta_vs_Lxy", "Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta_vs_Lxy", 50, -5, 5, 100, -10, 10, 60, 0, 30);
   TH3F *Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta_vs_Lxy = new TH3F("Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta_vs_Lxy", "Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta_vs_Lxy", 50, -5, 5, 100, -10, 10, 60, 0, 30);
   TH3F *Real_dimuon1_EtaResidual_vs_Eta_vs_Lxy = new TH3F("Real_dimuon1_EtaResidual_vs_Eta_vs_Lxy", "Real_dimuon1_EtaResidual_vs_Eta_vs_Lxy", 50, -5, 5, 100, -10, 10, 60, 0, 30);
   TH3F *Real_dimuon2_EtaResidual_vs_Eta_vs_Lxy = new TH3F("Real_dimuon2_EtaResidual_vs_Eta_vs_Lxy", "Real_dimuon2_EtaResidual_vs_Eta_vs_Lxy", 50, -5, 5, 100, -10, 10, 60, 0, 30);
   */
...
TH1F *UncuttableFake1_GEN_Dimuon_Opening_Angle = new TH1F("UncuttableFake1_GEN_Dimuon_Opening_Angle", "UncuttableFake1_GEN_Dimuon_Opening_Angle", 400, -4, 4);
TH1F *UncuttableFake1_RECO_Dimuon_Opening_Angle = new TH1F("UncuttableFake1_RECO_Dimuon_Opening_Angle", "UncuttableFake1_RECO_Dimuon_Opening_Angle", 400, -4, 4);
TH1F *UncuttableFake1_Dimuon_Opening_Angle_Residual = new TH1F("UncuttableFake1_Dimuon_Opening_Angle_Residual", "UncuttableFake1_Dimuon_Opening_Angle_Residual", 700, -7, 7);
TH2F *UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle = new TH2F("UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle", "UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle", 400, -4, 4, 700, -7, 7);

TH1F *UncuttableFake2_GEN_Dimuon_Opening_Angle = new TH1F("UncuttableFake2_GEN_Dimuon_Opening_Angle", "UncuttableFake2_GEN_Dimuon_Opening_Angle", 400, -4, 4);
TH1F *UncuttableFake2_RECO_Dimuon_Opening_Angle = new TH1F("UncuttableFake2_RECO_Dimuon_Opening_Angle", "UncuttableFake2_RECO_Dimuon_Opening_Angle", 400, -4, 4);
TH1F *UncuttableFake2_Dimuon_Opening_Angle_Residual = new TH1F("UncuttableFake2_Dimuon_Opening_Angle_Residual", "UncuttableFake2_Dimuon_Opening_Angle_Residual", 700, -7, 7);
TH2F *UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle = new TH2F("UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle", "UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle", 400, -4, 4, 700, -7, 7);
...
TH1F *UncuttableFake1_GEN_deltaR_Between_Dimuons = new TH1F("UncuttableFake1_GEN_deltaR_Between_Dimuons", "UncuttableFake1_GEN_deltaR_Between_Dimuons", 750, 0, 15);
TH1F *UncuttableFake1_RECO_deltaR_Between_Dimuons = new TH1F("UncuttableFake1_RECO_deltaR_Between_Dimuons", "UncuttableFake1_RECO_deltaR_Between_Dimuons", 750, 0, 15);
TH1F *UncuttableFake1_deltaR_Between_Dimuons_Residual = new TH1F("UncuttableFake1_deltaR_Between_Dimuons_Residual", "UncuttableFake1_deltaR_Between_Dimuons_Residual", 1500, -15, 15);
TH2F *UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR = new TH2F("UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR", "UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR", 750, 0, 15, 1500, -15, 15);

TH1F *UncuttableFake2_GEN_deltaR_Between_Dimuons = new TH1F("UncuttableFake2_GEN_deltaR_Between_Dimuons", "UncuttableFake2_GEN_deltaR_Between_Dimuons", 750, 0, 15);
TH1F *UncuttableFake2_RECO_deltaR_Between_Dimuons = new TH1F("UncuttableFake2_RECO_deltaR_Between_Dimuons", "UncuttableFake2_RECO_deltaR_Between_Dimuons", 750, 0, 15);
TH1F *UncuttableFake2_deltaR_Between_Dimuons_Residual = new TH1F("UncuttableFake2_deltaR_Between_Dimuons_Residual", "UncuttableFake2_deltaR_Between_Dimuons_Residual", 1500, -15, 15);
TH2F *UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR = new TH2F("UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR", "UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR", 750, 0, 15, 1500, -15, 15);
...
TH1F *UncuttableFake1_GEN_Dimuon_vertex_r = new TH1F("UncuttableFake1_GEN_Dimuon_vertex_r", "UncuttableFake1_GEN_Dimuon_vertex_r", 300, -30, 30);
TH1F *UncuttableFake1_RECO_Dimuon_vertex_r = new TH1F("UncuttableFake1_RECO_Dimuon_vertex_r", "UncuttableFake1_RECO_Dimuon_vertex_r", 300, -30, 30);
TH1F *UncuttableFake1_Dimuon_vertex_r_Residual = new TH1F("UncuttableFake1_Dimuon_vertex_r_Residual", "UncuttableFake1_Dimuon_vertex_r_Residual", 300, -30, 30);
TH2F *UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN = new TH2F("UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN", "UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN", 300, -30, 30, 300, -30, 30);
TH2F *UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r = new TH2F("UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r", "UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r", 60, 0, 30, 300, -30, 30);
TH2F *UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r = new TH2F("UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r", "UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r", 60, 0, 30, 300, -30, 30);

TH1F *UncuttableFake2_GEN_Dimuon_vertex_r = new TH1F("UncuttableFake2_GEN_Dimuon_vertex_r", "UncuttableFake2_GEN_Dimuon_vertex_r", 300, -30, 30);
TH1F *UncuttableFake2_RECO_Dimuon_vertex_r = new TH1F("UncuttableFake2_RECO_Dimuon_vertex_r", "UncuttableFake2_RECO_Dimuon_vertex_r", 300, -30, 30);
TH1F *UncuttableFake2_Dimuon_vertex_r_Residual = new TH1F("UncuttableFake2_Dimuon_vertex_r_Residual", "UncuttableFake2_Dimuon_vertex_r_Residual", 300, -30, 30);
TH2F *UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN = new TH2F("UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN", "UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN", 300, -30, 30, 300, -30, 30);
TH2F *UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r = new TH2F("UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r", "UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r", 60, 0, 30, 300, -30, 30);
TH2F *UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r = new TH2F("UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r", "UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r", 60, 0, 30, 300, -30, 30);

TH1F *UncuttableFake1_GEN_Dimuon_vertex_z = new TH1F("UncuttableFake1_GEN_Dimuon_vertex_z", "UncuttableFake1_GEN_Dimuon_vertex_z", 300, -30, 30);
TH1F *UncuttableFake1_RECO_Dimuon_vertex_z = new TH1F("UncuttableFake1_RECO_Dimuon_vertex_z", "UncuttableFake1_RECO_Dimuon_vertex_z", 300, -30, 30);
TH1F *UncuttableFake1_Dimuon_vertex_z_Residual = new TH1F("UncuttableFake1_Dimuon_vertex_z_Residual", "UncuttableFake1_Dimuon_vertex_z_Residual", 300, -30, 30);
TH2F *UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN = new TH2F("UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN", "UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN", 300, -30, 30, 300, -30, 30);
TH2F *UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z = new TH2F("UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z", "UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z", 60, 0, 30, 300, -30, 30);
TH2F *UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z = new TH2F("UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z", "UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z", 60, 0, 30, 300, -30, 30);

TH1F *UncuttableFake2_GEN_Dimuon_vertex_z = new TH1F("UncuttableFake2_GEN_Dimuon_vertex_z", "UncuttableFake2_GEN_Dimuon_vertex_z", 300, -30, 30);
TH1F *UncuttableFake2_RECO_Dimuon_vertex_z = new TH1F("UncuttableFake2_RECO_Dimuon_vertex_z", "UncuttableFake2_RECO_Dimuon_vertex_z", 300, -30, 30);
TH1F *UncuttableFake2_Dimuon_vertex_z_Residual = new TH1F("UncuttableFake2_Dimuon_vertex_z_Residual", "UncuttableFake2_Dimuon_vertex_z_Residual", 300, -30, 30);
TH2F *UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN = new TH2F("UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN", "UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN", 300, -30, 30, 300, -30, 30);
TH2F *UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z = new TH2F("UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z", "UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z", 60, 0, 30, 300, -30, 30);
TH2F *UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z = new TH2F("UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z", "UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z", 60, 0, 30, 300, -30, 30);
...
void efficiency_hitrecovery(TString fileName){
	...
	Bool_t is2MuJets;
	Bool_t is2DiMuons;
	Bool_t is2DiMuonsConsistentVtxOK;
	Bool_t is2DiMuonsDzOK_ConsistentVtx;
	Bool_t isDiMuonHLTFired;
	Bool_t is2DiMuonsMassOK_ConsistentVtx;
	Bool_t is2DiMuonsIsoTkOK_ConsistentVtx;
	Bool_t isVertexOK;
...
//Vertex information
	...
	Int_t ev_is2DiMuonsConsistentVtxOK = 0;
	Int_t ev_isPixelHitOK = 0;
	Int_t ev_is2DiMuonsDzOK_ConsistentVtx = 0;
	Int_t ev_is2DiMuonsMassOK_ConsistentVtx = 0;
	Int_t ev_is2DiMuonsIsoTkOK_ConsistentVtx = 0;
	...
	while ((chEl=(TChainElement*)next())) {
		...
		t->SetBranchAddress("is2DiMuonsConsistentVtxOK",          &is2DiMuonsConsistentVtxOK);
		t->SetBranchAddress("is2DiMuonsDzOK_ConsistentVtx",       &is2DiMuonsDzOK_ConsistentVtx);
		t->SetBranchAddress("isDiMuonHLTFired",               &isDiMuonHLTFired);
		t->SetBranchAddress("is2DiMuonsMassOK_ConsistentVtx",     &is2DiMuonsMassOK_ConsistentVtx);
		t->SetBranchAddress("is2DiMuonsIsoTkOK_ConsistentVtx",    &is2DiMuonsIsoTkOK_ConsistentVtx);
		...
		for(int k=0;k<t->GetEntries();k++){
						...
						if(is2DiMuons){
							...
							if(is2DiMuonsConsistentVtxOK){
								...
								if( (diMuonC_m1_FittedVtx_hitpix==1||diMuonC_m2_FittedVtx_hitpix==1)&&(diMuonF_m1_FittedVtx_hitpix==1||diMuonF_m2_FittedVtx_hitpix==1) ){
									ev_isPixelHitOK++;
									if(is2DiMuonsDzOK_ConsistentVtx){
										ev_is2DiMuonsDzOK_ConsistentVtx++;
										brokenCounter++;
										if(is2DiMuonsMassOK_ConsistentVtx){
											ev_is2DiMuonsMassOK_ConsistentVtx++;
											brokenCounter++;
											if(is2DiMuonsIsoTkOK_ConsistentVtx){
												ev_is2DiMuonsIsoTkOK_ConsistentVtx++;
												brokenCounter++;
												if(isDiMuonHLTFired){
													ev_isDiMuonHLTFired++;
													brokenCounter++;
			...
			if(triggerFlag_std > 0 && triggerFlag_lxy > 0){
				...
				if(diMuonC_ConsistentVtx_Lxy > -800) Real_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy); 
				if(diMuonF_ConsistentVtx_Lxy > -800) Real_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy); 
				if(diMuonC_ConsistentVtx_eta > -800) Real_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
				if(diMuonF_ConsistentVtx_eta > -800) Real_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
				if(diMuonC_ConsistentVtx_phi > -800) Real_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
				if(diMuonF_ConsistentVtx_phi > -800) Real_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
				if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800) Real_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
				if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800) Real_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
				if(diMuonC_ConsistentVtx_m > -800) Real_Reco_MassCompatability->Fill(diMuonC_ConsistentVtx_m,diMuonF_ConsistentVtx_m); 
				if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800 && diMuonF_ConsistentVtx_Lxy > -800) Real_Reco_pT_vs_Lxy->Fill(diMuonF_ConsistentVtx_Lxy, sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));	
				if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800 && diMuonC_ConsistentVtx_Lxy > -800) Real_Reco_pT_vs_Lxy->Fill(diMuonC_ConsistentVtx_Lxy, sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));	
				if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_phi > -800){
					Real_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);
					Real_dimuon1_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);
				}
				if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_phi > -800){
					Real_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);
					Real_dimuon2_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);
				}

				if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_Lxy > -800){
					Real_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);
					Real_dimuon1_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);
				}
				if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_Lxy > -800){
					Real_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy);
					Real_dimuon2_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy);
				}

				if(diMuonC_ConsistentVtx_Lxy > -800) Real_dimuon1_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
				if(diMuonF_ConsistentVtx_Lxy > -800) Real_dimuon2_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
				if(diMuonC_ConsistentVtx_eta > -800) Real_dimuon1_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
				if(diMuonF_ConsistentVtx_eta > -800) Real_dimuon2_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
				if(diMuonC_ConsistentVtx_phi > -800) Real_dimuon1_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
				if(diMuonF_ConsistentVtx_phi > -800) Real_dimuon2_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
				if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800) Real_dimuon1_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
				if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800) Real_dimuon2_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
				if(diMuonC_ConsistentVtx_m > -800) Real_dimuon1_Reco_MassCompatability->Fill(diMuonC_ConsistentVtx_m,diMuonF_ConsistentVtx_m);
				//real match loop
				...
				if(diMuonC_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_eta > -800){
					...
					for(int r = 0; r < reco_real_muons_phi.size(); r++){ //Find best real_match to diMuonC
						double dphi_real = My_dPhi(reco_real_muons_phi[r], diMuonC_ConsistentVtx_phi);
						double deta_real = reco_real_muons_eta[r] - diMuonC_ConsistentVtx_eta;
						double dR_real = sqrt(dphi_real*dphi_real + deta_real*deta_real);
					...
					for(int r = 0; r < reco_real_muons_phi.size(); r++){ //Find best real_match to diMuonF
						double dphi_real = My_dPhi(reco_real_muons_phi[r], diMuonF_ConsistentVtx_phi);
						double deta_real = reco_real_muons_eta[r] - diMuonF_ConsistentVtx_eta;
						double dR_real = sqrt(dphi_real*dphi_real + deta_real*deta_real);
				...
				if(problem_nodupCounter > 0) cout << "There is a problem with no duplicate real_matching (uncuttable dimuon 0)" << endl;
				...
				if(MatchRECOtoGENdimuons(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi, diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
					//eta
					Real_dimuon1_EtaResidual->Fill(genA0_eta - diMuonC_ConsistentVtx_eta);
					Real_dimuon1_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonC_ConsistentVtx_eta);
					Real_dimuon1_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonC_ConsistentVtx_eta);

					Real_dimuon2_EtaResidual->Fill(genA1_eta - diMuonF_ConsistentVtx_eta);
					Real_dimuon2_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonF_ConsistentVtx_eta);
					Real_dimuon2_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonF_ConsistentVtx_eta);

					//phi
					Real_dimuon1_PhiResidual->Fill(genA0_phi - diMuonC_ConsistentVtx_phi);
					Real_dimuon1_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonC_ConsistentVtx_phi);
					Real_dimuon1_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonC_ConsistentVtx_phi);

					Real_dimuon2_PhiResidual->Fill(genA1_phi - diMuonF_ConsistentVtx_phi);
					Real_dimuon2_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonF_ConsistentVtx_phi);
					Real_dimuon2_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonF_ConsistentVtx_phi);

					//Lxy
					Real_dimuon1_LxyResidual->Fill(genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
					Real_dimuon1_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);

					Real_dimuon2_LxyResidual->Fill(genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
					Real_dimuon2_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

					//vertex
					Real_Dimuon1_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
					Real_Dimuon1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
					Real_Dimuon1_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
					Real_Dimuon1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy), genA0_Lxy - diMuonC_ConsistentVtx_Lxy);

					Real_Dimuon1_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
					Real_Dimuon1_RECO_Dimuon_vertex_z->Fill(diMuonC_ConsistentVtx_vz);
					Real_Dimuon1_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonC_ConsistentVtx_vz);
					Real_Dimuon1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonC_ConsistentVtx_vz);
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_ConsistentVtx_vz, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);

					Real_Dimuon2_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
					Real_Dimuon2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
					Real_Dimuon2_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
					Real_Dimuon2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy), genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

					Real_Dimuon2_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
					Real_Dimuon2_RECO_Dimuon_vertex_z->Fill(diMuonF_ConsistentVtx_vz);
					Real_Dimuon2_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonF_ConsistentVtx_vz);
					Real_Dimuon2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonF_ConsistentVtx_vz);
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_ConsistentVtx_vz, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
				
				}else{ //diMuonC -> A1, diMuonF -> A0
					//eta
					Real_dimuon1_EtaResidual->Fill(genA0_eta - diMuonF_ConsistentVtx_eta);
					Real_dimuon1_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonF_ConsistentVtx_eta);
					Real_dimuon1_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonF_ConsistentVtx_eta);

					Real_dimuon2_EtaResidual->Fill(genA1_eta - diMuonC_ConsistentVtx_eta);
					Real_dimuon2_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonC_ConsistentVtx_eta);
					Real_dimuon2_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonC_ConsistentVtx_eta);

					//phi
					Real_dimuon1_PhiResidual->Fill(genA0_phi - diMuonF_ConsistentVtx_phi);
					Real_dimuon1_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonF_ConsistentVtx_phi);
					Real_dimuon1_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonF_ConsistentVtx_phi);

					Real_dimuon2_PhiResidual->Fill(genA1_phi - diMuonC_ConsistentVtx_phi);
					Real_dimuon2_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonC_ConsistentVtx_phi);
					Real_dimuon2_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonC_ConsistentVtx_phi);

					//Lxy
					Real_dimuon1_LxyResidual->Fill(genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
					Real_dimuon1_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);

					Real_dimuon2_LxyResidual->Fill(genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
					Real_dimuon2_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);

					//vertex
					Real_Dimuon1_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
					Real_Dimuon1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
					Real_Dimuon1_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
					Real_Dimuon1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy), genA0_Lxy - diMuonF_ConsistentVtx_Lxy);

					Real_Dimuon1_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
					Real_Dimuon1_RECO_Dimuon_vertex_z->Fill(diMuonF_ConsistentVtx_vz);
					Real_Dimuon1_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonF_ConsistentVtx_vz);
					Real_Dimuon1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonF_ConsistentVtx_vz);
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
					Real_Dimuon1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_ConsistentVtx_vz, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
					
					Real_Dimuon2_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
					Real_Dimuon2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
					Real_Dimuon2_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
					Real_Dimuon2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy), genA1_Lxy - diMuonC_ConsistentVtx_Lxy);

					Real_Dimuon2_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
					Real_Dimuon2_RECO_Dimuon_vertex_z->Fill(diMuonC_ConsistentVtx_vz);
					Real_Dimuon2_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonC_ConsistentVtx_vz);
					Real_Dimuon2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonC_ConsistentVtx_vz);
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
					Real_Dimuon2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_ConsistentVtx_vz, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
				...
				if(diMuonF_ConsistentVtx_phi > -800 && diMuonC_ConsistentVtx_phi > -800 && diMuonF_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_eta > -800){
				Real_RECO_Dimuon_Opening_Angle->Fill(My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
				Real_Dimuon_Opening_Angle_Residual->Fill(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
				Real_Dimuon_opening_Angle_Residual_vs_GENangle->Fill(My_dPhi(genA0_phi,genA1_phi), My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));

//Print a few values
				if(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi) > 0.5 || My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi) < -0.5){
					cout << "GenA0, GenA1       : " << genA0_phi << ", " << genA1_phi << endl;
					cout << "RecA0, RecA1       : " << diMuonC_ConsistentVtx_phi << ", " << diMuonF_ConsistentVtx_phi << endl;
					cout << "GEN dphi, RECO dphi: " << My_dPhi(genA0_phi,genA1_phi) << ", " << My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi) << endl; 
				}
				}
				...
				double RECO_deta = diMuonC_ConsistentVtx_eta - diMuonF_ConsistentVtx_eta;
				double RECO_dphi = My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi);
			...
			if(triggerFlag_std > 0 && triggerFlag_lxy == 0){
				...
				if(diMuonC_ConsistentVtx_Lxy > -800) Fake_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
				if(diMuonF_ConsistentVtx_Lxy > -800) Fake_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
				if(diMuonC_ConsistentVtx_eta > -800) Fake_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
				if(diMuonF_ConsistentVtx_eta > -800) Fake_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
				if(diMuonC_ConsistentVtx_phi > -800) Fake_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
				if(diMuonF_ConsistentVtx_phi > -800) Fake_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
				if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800) Fake_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
				if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800) Fake_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
				if(diMuonC_ConsistentVtx_m > -800) Fake_Reco_MassCompatability->Fill(diMuonC_ConsistentVtx_m,diMuonF_ConsistentVtx_m);
				if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800 && diMuonF_ConsistentVtx_Lxy > -800) Fake_Reco_pT_vs_Lxy->Fill(diMuonF_ConsistentVtx_Lxy, sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
				if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800 && diMuonC_ConsistentVtx_Lxy > -800) Fake_Reco_pT_vs_Lxy->Fill(diMuonC_ConsistentVtx_Lxy, sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
				...
				if(fabs(genA0_Lxy)>=4.4 || fabs(genA0_Lz)>=34.5){
					...
					if(diMuonC_ConsistentVtx_Lxy > -800) Fake_dimuon1_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
					if(diMuonC_ConsistentVtx_eta > -800) Fake_dimuon1_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
					if(diMuonC_ConsistentVtx_phi > -800) Fake_dimuon1_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
					if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800) Fake_dimuon1_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
					if(diMuonC_ConsistentVtx_m > -800) Fake_dimuon1_Reco_MassCompatability->Fill(diMuonC_ConsistentVtx_m,diMuonF_ConsistentVtx_m);
					if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800 && diMuonC_ConsistentVtx_Lxy > -800) Fake_dimuon1_Reco_pT_vs_Lxy->Fill(diMuonC_ConsistentVtx_Lxy, sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));

					if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_phi > -800){
						Fake_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);
						Fake_dimuon1_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);
					}

					if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_Lxy > -800){
						Fake_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);
						Fake_dimuon1_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);
					}

					if(fabs(diMuonC_ConsistentVtx_Lxy) < 4.4 && fabs( sqrt( (diMuonC_ConsistentVtx_L*diMuonC_ConsistentVtx_L) - (diMuonC_ConsistentVtx_Lxy*diMuonC_ConsistentVtx_Lxy))  ) < 34.5){
						cout << "" << endl;
						cout << "There is an uncuttable dimuon0 in this event" << endl;
						//Begin uncuttable dimuon0 loop
						...
						cout << diMuonC_ConsistentVtx_eta << ", " << diMuonC_ConsistentVtx_phi << endl;
						cout << diMuonF_ConsistentVtx_eta << ", " << diMuonF_ConsistentVtx_phi << endl;

						uncuttableFakeCounter++;
						Uncuttable_Fake_dimuon1_Gen_Lxy->Fill(genA0_Lxy);
						Uncuttable_Fake_dimuon1_Gen_Lz->Fill(genA0_Lz);
						Uncuttable_Fake_dimuon1_Gen_Eta->Fill(genA0_eta);
						Uncuttable_Fake_dimuon1_Gen_Phi->Fill(genA0_phi);
						Uncuttable_Fake_dimuon1_Gen_pT->Fill(sqrt(genA0_px*genA0_px+genA0_py*genA0_py));
						Uncuttable_Fake_dimuon1_Gen_pT_vs_Lxy->Fill(genA0_Lxy,sqrt(genA0_px*genA0_px+genA0_py*genA0_py));

						if(diMuonC_ConsistentVtx_Lxy > -800) Uncuttable_Fake_dimuon1_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
						if(diMuonC_ConsistentVtx_eta > -800) Uncuttable_Fake_dimuon1_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
						if(diMuonC_ConsistentVtx_phi > -800) Uncuttable_Fake_dimuon1_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
						if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800) Uncuttable_Fake_dimuon1_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
						if(diMuonC_ConsistentVtx_m > -800) Uncuttable_Fake_dimuon1_Reco_MassCompatability->Fill(diMuonC_ConsistentVtx_m,diMuonF_ConsistentVtx_m);
						...
						if(diMuonC_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_eta > -800){
							...
							for(int r = 0; r < reco_muons_phi.size(); r++){ //Find best match to diMuonC
								double dphi = My_dPhi(reco_muons_phi[r], diMuonC_ConsistentVtx_phi);
								double deta = reco_muons_eta[r] - diMuonC_ConsistentVtx_eta;
								double dR = sqrt(dphi*dphi + deta*deta);
							...
							for(int r = 0; r < reco_muons_phi.size(); r++){ //Find best match to diMuonF
								double dphi = My_dPhi(reco_muons_phi[r], diMuonF_ConsistentVtx_phi);
								double deta = reco_muons_eta[r] - diMuonF_ConsistentVtx_eta;
								double dR = sqrt(dphi*dphi + deta*deta);
						...
						if(problemCounter > 0) cout << "There is a problem matching (uncuttable dimuon 0)" << endl;
						int problem_nodupCounter = 0;
						...
						if(problem_nodupCounter > 0) cout << "There is a problem with no duplicate matching (uncuttable dimuon 0)" << endl;
						...
						//IMPORTANT:  IF WE ARE IN THIS LOOP, THEN WE KNOW THAT RECO DIMUONC IS BAD.  HOWEVER WE DON'T KNOW IF DIMUONC IS A0 OR A1
						if(MatchRECOtoGENdimuons(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi, diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
							//eta
							Uncuttable_Fake_dimuon1_EtaResidual->Fill(genA0_eta - diMuonC_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonC_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonC_ConsistentVtx_eta);


							//phi
							Uncuttable_Fake_dimuon1_PhiResidual->Fill(genA0_phi - diMuonC_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonC_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonC_ConsistentVtx_phi);


							//Lxy
							Uncuttable_Fake_dimuon1_LxyResidual->Fill(genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
							Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);


							//Vertex
							UncuttableFake1_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
							UncuttableFake1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy), genA0_Lxy - diMuonC_ConsistentVtx_Lxy);

							UncuttableFake1_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
							UncuttableFake1_RECO_Dimuon_vertex_z->Fill(diMuonC_ConsistentVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonC_ConsistentVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonC_ConsistentVtx_vz);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_ConsistentVtx_vz, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);



						}else{ //diMuonC -> A1, diMuonF -> A0
							//eta
							Uncuttable_Fake_dimuon1_EtaResidual->Fill(genA1_eta - diMuonC_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonC_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonC_ConsistentVtx_eta);

							//phi

							Uncuttable_Fake_dimuon1_PhiResidual->Fill(genA1_phi - diMuonC_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonC_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonC_ConsistentVtx_phi);

							//Lxy

							Uncuttable_Fake_dimuon1_LxyResidual->Fill(genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
							Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);

							//Vertex
							UncuttableFake1_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
							UncuttableFake1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy), genA1_Lxy - diMuonC_ConsistentVtx_Lxy);

							UncuttableFake1_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
							UncuttableFake1_RECO_Dimuon_vertex_z->Fill(diMuonC_ConsistentVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonC_ConsistentVtx_vz);
							UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonC_ConsistentVtx_vz);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
							UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_ConsistentVtx_vz, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
						}

						//Residual plots for individual muons.
						...
						if(diMuonC_match0 == bestmatch_no_duplicates_0){
							Uncuttable_Fake_Muon_00_Eta_Residual->Fill(genA0Mu0_eta - reco_muons_eta[bestmatch_no_duplicates_0]);
							Uncuttable_Fake_Muon_00_Eta_Residual_vs_Eta->Fill(genA0Mu0_eta, genA0Mu0_eta - reco_muons_eta[bestmatch_no_duplicates_0]);
							Uncuttable_Fake_Muon_00_Phi_Residual->Fill(genA0Mu0_phi - reco_muons_phi[bestmatch_no_duplicates_0]);
							Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi->Fill(genA0Mu0_phi, genA0Mu0_phi - reco_muons_phi[bestmatch_no_duplicates_0]);
						}
						if(diMuonC_match0 == bestmatch_no_duplicates_1){
							Uncuttable_Fake_Muon_01_Eta_Residual->Fill(genA0Mu1_eta - reco_muons_eta[bestmatch_no_duplicates_1]);
							Uncuttable_Fake_Muon_01_Eta_Residual_vs_Eta->Fill(genA0Mu1_eta, genA0Mu1_eta - reco_muons_eta[bestmatch_no_duplicates_1]);
							Uncuttable_Fake_Muon_01_Phi_Residual->Fill(genA0Mu1_phi - reco_muons_phi[bestmatch_no_duplicates_1]);
							Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi->Fill(genA0Mu1_phi, genA0Mu1_phi - reco_muons_phi[bestmatch_no_duplicates_1]);
						}
						if(diMuonC_match0 == bestmatch_no_duplicates_2){
							Uncuttable_Fake_Muon_10_Eta_Residual->Fill(genA1Mu0_eta - reco_muons_eta[bestmatch_no_duplicates_2]);
							Uncuttable_Fake_Muon_10_Eta_Residual_vs_Eta->Fill(genA1Mu0_eta, genA1Mu0_eta - reco_muons_eta[bestmatch_no_duplicates_2]);
							Uncuttable_Fake_Muon_10_Phi_Residual->Fill(genA1Mu0_phi - reco_muons_phi[bestmatch_no_duplicates_2]);
							Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi->Fill(genA1Mu0_phi, genA1Mu0_phi - reco_muons_phi[bestmatch_no_duplicates_2]);
						}
						if(diMuonC_match0 == bestmatch_no_duplicates_3){
							Uncuttable_Fake_Muon_11_Eta_Residual->Fill(genA1Mu1_eta - reco_muons_eta[bestmatch_no_duplicates_3]);
							Uncuttable_Fake_Muon_11_Eta_Residual_vs_Eta->Fill(genA1Mu1_eta, genA1Mu1_eta - reco_muons_eta[bestmatch_no_duplicates_3]);
							Uncuttable_Fake_Muon_11_Phi_Residual->Fill(genA1Mu1_phi - reco_muons_phi[bestmatch_no_duplicates_3]);
							Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi->Fill(genA1Mu1_phi, genA1Mu1_phi - reco_muons_phi[bestmatch_no_duplicates_3]);
						}
						...
						//Geometry
						UncuttableFake1_GEN_Dimuon_Opening_Angle->Fill(My_dPhi(genA0_phi,genA1_phi));
						UncuttableFake1_RECO_Dimuon_Opening_Angle->Fill(My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
						UncuttableFake1_Dimuon_Opening_Angle_Residual->Fill(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
						UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle->Fill(My_dPhi(genA0_phi,genA1_phi), My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
						...
						double RECO_deta_forUncut1 = diMuonC_ConsistentVtx_eta - diMuonF_ConsistentVtx_eta;
						double RECO_dphi_forUncut1 = My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi);
						double RECO_dr_forUncut1 = sqrt(RECO_deta_forUncut1*RECO_deta_forUncut1 + RECO_dphi_forUncut1*RECO_dphi_forUncut1);

						UncuttableFake1_GEN_deltaR_Between_Dimuons->Fill(GEN_dr_forUncut1);
						UncuttableFake1_RECO_deltaR_Between_Dimuons->Fill(RECO_dr_forUncut1);
						UncuttableFake1_deltaR_Between_Dimuons_Residual->Fill(GEN_dr_forUncut1 - RECO_dr_forUncut1);
						UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->Fill(GEN_dr_forUncut1, GEN_dr_forUncut1 - RECO_dr_forUncut1);
					}
				}
				...
				if(fabs(genA1_Lxy)>=4.4 || fabs(genA1_Lz)>=34.5){
					...
					if(diMuonF_ConsistentVtx_Lxy > -800) Fake_dimuon2_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
					if(diMuonF_ConsistentVtx_eta > -800) Fake_dimuon2_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
					if(diMuonF_ConsistentVtx_phi > -800) Fake_dimuon2_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
					if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800) Fake_dimuon2_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
					if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800 && diMuonF_ConsistentVtx_Lxy > -800) Fake_dimuon2_Reco_pT_vs_Lxy->Fill(diMuonF_ConsistentVtx_Lxy, sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));

					if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_phi > -800){
						Fake_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);
						Fake_dimuon2_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);
					}

					if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_Lxy > -800){ 
						Fake_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy); 
						Fake_dimuon2_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy); 
					} 
					//real matching loop
				...
				*/
					...
					if(fabs(diMuonF_ConsistentVtx_Lxy) < 4.4 && fabs( sqrt( (diMuonF_ConsistentVtx_L*diMuonF_ConsistentVtx_L) - (diMuonF_ConsistentVtx_Lxy*diMuonF_ConsistentVtx_Lxy))  ) < 34.5){ 
						//Begin uncuttable dimuon1 loop
						cout << "" << endl;
						cout << "There is an uncuttable dimuon1 in this event" << endl;
						uncuttableFakeCounter++;
						Uncuttable_Fake_dimuon2_Gen_Lxy->Fill(genA1_Lxy);
						Uncuttable_Fake_dimuon2_Gen_Lz->Fill(genA1_Lz);
						Uncuttable_Fake_dimuon2_Gen_Eta->Fill(genA1_eta);
						Uncuttable_Fake_dimuon2_Gen_Phi->Fill(genA1_phi);
						Uncuttable_Fake_dimuon2_Gen_pT->Fill(sqrt(genA1_px*genA1_px+genA1_py*genA1_py));
						Uncuttable_Fake_dimuon2_Gen_MassCompatability->Fill(genA0_m, genA1_m);
						Uncuttable_Fake_dimuon2_Gen_pT_vs_Lxy->Fill(genA1_Lxy,sqrt(genA1_px*genA1_px+genA1_py*genA1_py));

						if(diMuonF_ConsistentVtx_Lxy > -800) Uncuttable_Fake_dimuon2_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
						if(diMuonF_ConsistentVtx_eta > -800) Uncuttable_Fake_dimuon2_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
						if(diMuonF_ConsistentVtx_phi > -800) Uncuttable_Fake_dimuon2_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
						if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800) Uncuttable_Fake_dimuon2_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
						...
						if(problemCounter > 0) cout << "There is a problem matching (uncuttable dimuon 1)" << endl;
						int problem_nodupCounter = 0;
						if(bestmatch_no_duplicates_0 == diMuonC_match0){
							if(bestmatch_no_duplicates_1 != diMuonC_match1) problem_nodupCounter++;
						}
						...
						if(problem_nodupCounter > 0) cout << "There is a problem with no duplicate matching (uncuttable dimuon 1)" << endl;
						//Match GEN dimuons to RECO dimuons
						//  GEN dimuon 	                                = genA0
						//  GEN muons to genA0                          = genA0Mu0 and genA0Mu1 
						//  These GEN muons have RECO matches           = reco_real_muons_phi[bestreal_match_no_duplicates_0] and reco_real_muons_phi[bestreal_match_no_duplicates_1]
						...
						//IMPORTANT:  IF WE ARE IN THIS LOOP, THEN WE KNOW THAT RECO DIMUONF IS BAD.  HOWEVER WE DON'T KNOW IF DIMUONF IS A0 OR A1
						if(MatchRECOtoGENdimuons(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi, diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
							//eta

							Uncuttable_Fake_dimuon2_EtaResidual->Fill(genA1_eta - diMuonF_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonF_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonF_ConsistentVtx_eta);

							//phi

							Uncuttable_Fake_dimuon2_PhiResidual->Fill(genA1_phi - diMuonF_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonF_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonF_ConsistentVtx_phi);

							//Lxy

							Uncuttable_Fake_dimuon2_LxyResidual->Fill(genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
							Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

//vertex
							UncuttableFake2_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
							UncuttableFake2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy), genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

							UncuttableFake2_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
							UncuttableFake2_RECO_Dimuon_vertex_z->Fill(diMuonF_ConsistentVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonF_ConsistentVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonF_ConsistentVtx_vz);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_ConsistentVtx_vz, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

						}else{ //diMuonC -> A1, diMuonF -> A0
							//eta
							Uncuttable_Fake_dimuon2_EtaResidual->Fill(genA0_eta - diMuonF_ConsistentVtx_eta);
							Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonF_ConsistentVtx_eta);                                                        

							Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonF_ConsistentVtx_eta);


							//phi
							Uncuttable_Fake_dimuon2_PhiResidual->Fill(genA0_phi - diMuonF_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonF_ConsistentVtx_phi);
							Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonF_ConsistentVtx_phi);


							//Lxy
							Uncuttable_Fake_dimuon2_LxyResidual->Fill(genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
							Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);

//vertex
							UncuttableFake2_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
							UncuttableFake2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy), genA0_Lxy - diMuonF_ConsistentVtx_Lxy);

							UncuttableFake2_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
							UncuttableFake2_RECO_Dimuon_vertex_z->Fill(diMuonF_ConsistentVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonF_ConsistentVtx_vz);
							UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonF_ConsistentVtx_vz);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
							UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_ConsistentVtx_vz, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
						...
						//Geometry
						UncuttableFake2_GEN_Dimuon_Opening_Angle->Fill(My_dPhi(genA0_phi,genA1_phi));
						UncuttableFake2_RECO_Dimuon_Opening_Angle->Fill(My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
						UncuttableFake2_Dimuon_Opening_Angle_Residual->Fill(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
						UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle->Fill(My_dPhi(genA0_phi,genA1_phi), My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));

						double GEN_deta_forUncut2 = genA0_eta-genA1_eta;
						double GEN_dphi_forUncut2 = My_dPhi(genA0_phi,genA1_phi);
						double GEN_dr_forUncut2 = sqrt(GEN_deta_forUncut2*GEN_deta_forUncut2 + GEN_dphi_forUncut2*GEN_dphi_forUncut2);

						double RECO_deta_forUncut2 = diMuonC_ConsistentVtx_eta - diMuonF_ConsistentVtx_eta;
						double RECO_dphi_forUncut2 = My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi);
						double RECO_dr_forUncut2 = sqrt(RECO_deta_forUncut2*RECO_deta_forUncut2 + RECO_dphi_forUncut2*RECO_dphi_forUncut2);

						UncuttableFake2_GEN_deltaR_Between_Dimuons->Fill(GEN_dr_forUncut2);
						UncuttableFake2_RECO_deltaR_Between_Dimuons->Fill(RECO_dr_forUncut2);
						UncuttableFake2_deltaR_Between_Dimuons_Residual->Fill(GEN_dr_forUncut2 - RECO_dr_forUncut2);
						UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->Fill(GEN_dr_forUncut2, GEN_dr_forUncut2 - RECO_dr_forUncut2);
					}
				}
	...
	std::cout<<" Events with 2DimVtxOK          "<<ev_is2DiMuonsConsistentVtxOK<<"    reff  "<<ev_is2DiMuonsConsistentVtxOK/(1.0*ev_is2DiMuons)<<std::endl;
	std::cout<<" Events with 2DimHitPix         "<<ev_isPixelHitOK<<"     reff  "<<ev_isPixelHitOK/(1.0*ev_is2DiMuonsConsistentVtxOK)<<std::endl;
	std::cout<<" Events with 2DimDzOK           "<<ev_is2DiMuonsDzOK_ConsistentVtx<<"   reff   "<<ev_is2DiMuonsDzOK_ConsistentVtx/(1.0*ev_isPixelHitOK)<<std::endl;
	std::cout<<" Events with 2DimMassOK         "<<ev_is2DiMuonsMassOK_ConsistentVtx<<"  reff   "<<ev_is2DiMuonsMassOK_ConsistentVtx/(1.0*ev_is2DiMuonsDzOK_ConsistentVtx)<<endl;
	std::cout<<" Events with 2DimIsoOK          "<<ev_is2DiMuonsIsoTkOK_ConsistentVtx<<"   reff   "<<ev_is2DiMuonsIsoTkOK_ConsistentVtx/(1.0*ev_is2DiMuonsMassOK_ConsistentVtx)<<endl;
	std::cout<<" Events with 2DimHLT            "<<ev_isDiMuonHLTFired<<"   reff   "<<ev_isDiMuonHLTFired/(1.0*ev_is2DiMuonsIsoTkOK_ConsistentVtx)<<endl;
	...
	if(uncuttableFakeCounter != 0) std::cout << "Uncuttable fake rate (#UncuttableFakes/#Events): " << std::setprecision(25) << (double)uncuttableFakeCounter/ev_all << std::endl;
	if(uncuttableFakeCounter == 0)  std::cout << "Uncuttable fake rate (#UncuttableFakes/#Events): " << 0 << std::endl;
...
void makePlotsPretty(){
	...
	Uncuttable_Fake_dimuon1_Gen_Lxy->GetXaxis()->SetTitle("L_{XY} [cm]");
	Uncuttable_Fake_dimuon1_Gen_Lxy->GetYaxis()->SetTitle("Events / 0.2 cm");
	Uncuttable_Fake_dimuon1_Gen_Lz->GetXaxis()->SetTitle("L_{Z} [cm]");
	Uncuttable_Fake_dimuon1_Gen_Lz->GetYaxis()->SetTitle("Events / 0.2 cm");
	Uncuttable_Fake_dimuon1_Gen_Eta->GetXaxis()->SetTitle("#eta");
	Uncuttable_Fake_dimuon1_Gen_Eta->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon1_Gen_Phi->GetXaxis()->SetTitle("#phi [rad]");
	Uncuttable_Fake_dimuon1_Gen_Phi->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_dimuon1_Gen_pT->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon1_Gen_pT->GetYaxis()->SetTitle("Events / 1 [GeV]");
	Uncuttable_Fake_dimuon1_Gen_MassCompatability->GetXaxis()->SetTitle("Mass #mu#mu_{1} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon1_Gen_MassCompatability->GetYaxis()->SetTitle("Mass #mu#mu_{2} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon1_Gen_pT_vs_Lxy->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon1_Gen_pT_vs_Lxy->GetYaxis()->SetTitle("L_{XY} [cm]");

	Uncuttable_Fake_dimuon1_Reco_Lxy->GetXaxis()->SetTitle("L_{XY} [cm]");
	Uncuttable_Fake_dimuon1_Reco_Lxy->GetYaxis()->SetTitle("Events / 0.2 cm");
	Uncuttable_Fake_dimuon1_Reco_Eta->GetXaxis()->SetTitle("#eta");
	Uncuttable_Fake_dimuon1_Reco_Eta->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon1_Reco_Phi->GetXaxis()->SetTitle("#phi [rad]");
	Uncuttable_Fake_dimuon1_Reco_Phi->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_dimuon1_Reco_pT->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon1_Reco_pT->GetYaxis()->SetTitle("Events / 1 [GeV]");
	Uncuttable_Fake_dimuon1_Reco_MassCompatability->GetXaxis()->SetTitle("Mass #mu#mu_{1} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon1_Reco_MassCompatability->GetYaxis()->SetTitle("Mass #mu#mu_{2} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon1_Reco_pT_vs_Lxy->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon1_Reco_pT_vs_Lxy->GetYaxis()->SetTitle("L_{XY} [cm]");

	Uncuttable_Fake_dimuon2_Gen_Lxy->GetXaxis()->SetTitle("L_{XY} [cm]");
	Uncuttable_Fake_dimuon2_Gen_Lxy->GetYaxis()->SetTitle("Events / 0.2 cm");
	Uncuttable_Fake_dimuon2_Gen_Lz->GetXaxis()->SetTitle("L_{Z} [cm]");
	Uncuttable_Fake_dimuon2_Gen_Lz->GetYaxis()->SetTitle("Events / 0.2 cm");
	Uncuttable_Fake_dimuon2_Gen_Eta->GetXaxis()->SetTitle("#eta");
	Uncuttable_Fake_dimuon2_Gen_Eta->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon2_Gen_Phi->GetXaxis()->SetTitle("#phi [rad]");
	Uncuttable_Fake_dimuon2_Gen_Phi->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_dimuon2_Gen_pT->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon2_Gen_pT->GetYaxis()->SetTitle("Events / 1 [GeV]");
	Uncuttable_Fake_dimuon2_Gen_MassCompatability->GetXaxis()->SetTitle("Mass #mu#mu_{1} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon2_Gen_MassCompatability->GetYaxis()->SetTitle("Mass #mu#mu_{2} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon2_Gen_pT_vs_Lxy->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon2_Gen_pT_vs_Lxy->GetYaxis()->SetTitle("L_{XY} [cm]");

	Uncuttable_Fake_dimuon2_Reco_Lxy->GetXaxis()->SetTitle("L_{XY} [cm]");
	Uncuttable_Fake_dimuon2_Reco_Lxy->GetYaxis()->SetTitle("Events / 0.2 cm");
	Uncuttable_Fake_dimuon2_Reco_Eta->GetXaxis()->SetTitle("#eta");
	Uncuttable_Fake_dimuon2_Reco_Eta->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon2_Reco_Phi->GetXaxis()->SetTitle("#phi [rad]");
	Uncuttable_Fake_dimuon2_Reco_Phi->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_dimuon2_Reco_pT->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon2_Reco_pT->GetYaxis()->SetTitle("Events / 1 [GeV]");
	Uncuttable_Fake_dimuon2_Reco_MassCompatability->GetXaxis()->SetTitle("Mass #mu#mu_{1} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon2_Reco_MassCompatability->GetYaxis()->SetTitle("Mass #mu#mu_{2} [GeV/c^{2}]");
	Uncuttable_Fake_dimuon2_Reco_pT_vs_Lxy->GetXaxis()->SetTitle("p_{T} [GeV]");
	Uncuttable_Fake_dimuon2_Reco_pT_vs_Lxy->GetYaxis()->SetTitle("L_{XY} [cm]");

	Uncuttable_Fake_dimuon1_EtaResidual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_dimuon1_EtaResidual->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon2_EtaResidual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_dimuon2_EtaResidual->GetYaxis()->SetTitle("Events / 0.02 cm");

	Real_dimuon2_EtaResidual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Real_dimuon2_EtaResidual->GetYaxis()->SetTitle("Events / 0.02 cm");

	Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta->GetXaxis()->SetTitle("#eta_{GEN}");
	Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta->GetXaxis()->SetTitle("#eta_{GEN}");
	Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	...
	Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy->GetXaxis()->SetTitle("L_{XY}");
	Uncuttable_Fake_dimuon1_EtaResidual_vs_Lxy->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy->GetXaxis()->SetTitle("L_{XY}");
	Uncuttable_Fake_dimuon2_EtaResidual_vs_Lxy->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	...
	Uncuttable_Fake_dimuon1_PhiResidual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_dimuon1_PhiResidual->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon2_PhiResidual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_dimuon2_PhiResidual->GetYaxis()->SetTitle("Events / 0.02 cm");

	Real_dimuon2_PhiResidual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Real_dimuon2_PhiResidual->GetYaxis()->SetTitle("Events / 0.02 cm");

	Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi->GetXaxis()->SetTitle("#phi_{GEN}");
	Uncuttable_Fake_dimuon1_PhiResidual_vs_Phi->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi->GetXaxis()->SetTitle("#phi_{GEN}");
	Uncuttable_Fake_dimuon2_PhiResidual_vs_Phi->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	...
	Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy->GetXaxis()->SetTitle("L_{XY}");
	Uncuttable_Fake_dimuon1_PhiResidual_vs_Lxy->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy->GetXaxis()->SetTitle("L_{XY}");
	Uncuttable_Fake_dimuon2_PhiResidual_vs_Lxy->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	...
	Uncuttable_Fake_dimuon1_LxyResidual->GetXaxis()->SetTitle("#Lxy{GEN}-#Lxy{RECO}");
	Uncuttable_Fake_dimuon1_LxyResidual->GetYaxis()->SetTitle("Events / 0.02 cm");
	Uncuttable_Fake_dimuon2_LxyResidual->GetXaxis()->SetTitle("#Lxy{GEN}-#Lxy{RECO}");
	Uncuttable_Fake_dimuon2_LxyResidual->GetYaxis()->SetTitle("Events / 0.02 cm");

	Real_dimuon2_LxyResidual->GetXaxis()->SetTitle("#Lxy{GEN}-#Lxy{RECO}");
	Real_dimuon2_LxyResidual->GetYaxis()->SetTitle("Events / 0.02 cm");

	Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy->GetXaxis()->SetTitle("#Lxy{GEN}");
	Uncuttable_Fake_dimuon1_LxyResidual_vs_Lxy->GetYaxis()->SetTitle("#Lxy{GEN}-#Lxy{RECO}");
	Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy->GetXaxis()->SetTitle("#Lxy{GEN}");
	Uncuttable_Fake_dimuon2_LxyResidual_vs_Lxy->GetYaxis()->SetTitle("#Lxy{GEN}-#Lxy{RECO}");
	...
	Uncuttable_Fake_Muon_00_Eta_Residual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_00_Eta_Residual->GetYaxis()->SetTitle("Events / 0.02");
	Uncuttable_Fake_Muon_01_Eta_Residual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_01_Eta_Residual->GetYaxis()->SetTitle("Events / 0.02");
	Uncuttable_Fake_Muon_10_Eta_Residual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_10_Eta_Residual->GetYaxis()->SetTitle("Events / 0.02");
	Uncuttable_Fake_Muon_11_Eta_Residual->GetXaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_11_Eta_Residual->GetYaxis()->SetTitle("Events / 0.02");
	...
	Uncuttable_Fake_Muon_00_Phi_Residual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO} [rad]");
	Uncuttable_Fake_Muon_00_Phi_Residual->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_Muon_01_Phi_Residual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO} [rad]");
	Uncuttable_Fake_Muon_01_Phi_Residual->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_Muon_10_Phi_Residual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO} [rad]");
	Uncuttable_Fake_Muon_10_Phi_Residual->GetYaxis()->SetTitle("Events / 0.02 rad");
	Uncuttable_Fake_Muon_11_Phi_Residual->GetXaxis()->SetTitle("#phi_{GEN}-#phi_{RECO} [rad]");
	Uncuttable_Fake_Muon_11_Phi_Residual->GetYaxis()->SetTitle("Events / 0.02 rad");
	...
	Uncuttable_Fake_Muon_00_Eta_Residual_vs_Eta->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_00_Eta_Residual_vs_Eta->GetXaxis()->SetTitle("GEN #eta");
	Uncuttable_Fake_Muon_01_Eta_Residual_vs_Eta->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_01_Eta_Residual_vs_Eta->GetXaxis()->SetTitle("GEN #eta");
	Uncuttable_Fake_Muon_10_Eta_Residual_vs_Eta->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_10_Eta_Residual_vs_Eta->GetXaxis()->SetTitle("GEN #eta");
	Uncuttable_Fake_Muon_11_Eta_Residual_vs_Eta->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	Uncuttable_Fake_Muon_11_Eta_Residual_vs_Eta->GetXaxis()->SetTitle("GEN #eta");
	...
	Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_Muon_00_Phi_Residual_vs_Phi->GetXaxis()->SetTitle("GEN #phi");
	Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_Muon_01_Phi_Residual_vs_Phi->GetXaxis()->SetTitle("GEN #phi");
	Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_Muon_10_Phi_Residual_vs_Phi->GetXaxis()->SetTitle("GEN #phi");
	Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi->GetYaxis()->SetTitle("#phi_{GEN}-#phi_{RECO}");
	Uncuttable_Fake_Muon_11_Phi_Residual_vs_Phi->GetXaxis()->SetTitle("GEN #phi");
	...
	UncuttableFake1_GEN_Dimuon_Opening_Angle->GetXaxis()->SetTitle("#Delta#phi Between GEN Dimuons [rads]");
	UncuttableFake1_GEN_Dimuon_Opening_Angle->GetYaxis()->SetTitle("Events / 0.02 rad");

	UncuttableFake1_RECO_Dimuon_Opening_Angle->GetXaxis()->SetTitle("#Delta#phi Between RECO Dimuons [rads]");
	UncuttableFake1_RECO_Dimuon_Opening_Angle->GetYaxis()->SetTitle("Events / 0.02 rad");

	UncuttableFake1_Dimuon_Opening_Angle_Residual->GetXaxis()->SetTitle("Residual #Delta#phi Between Dimuon (#Delta#phi_{GEN}-#Delta#phi_{RECO}) [rads]");
	UncuttableFake1_Dimuon_Opening_Angle_Residual->GetYaxis()->SetTitle("Events / 0.02 rad");

	UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle->GetYaxis()->SetTitle("Residual #Delta#phi Between Dimuon (#Delta#phi_{GEN}-#Delta#phi_{RECO}) [rads]");
	UncuttableFake1_Dimuon_opening_Angle_Residual_vs_GENangle->GetXaxis()->SetTitle("GEN #Delta#phi [rads]");

	UncuttableFake2_GEN_Dimuon_Opening_Angle->GetXaxis()->SetTitle("#Delta#phi Between GEN Dimuons [rads]");
	UncuttableFake2_GEN_Dimuon_Opening_Angle->GetYaxis()->SetTitle("Events / 0.02 rad");

	UncuttableFake2_RECO_Dimuon_Opening_Angle->GetXaxis()->SetTitle("#Delta#phi Between RECO Dimuons [rads]");
	UncuttableFake2_RECO_Dimuon_Opening_Angle->GetYaxis()->SetTitle("Events / 0.02 rad");

	UncuttableFake2_Dimuon_Opening_Angle_Residual->GetXaxis()->SetTitle("Residual #Delta#phi Between Dimuon (#Delta#phi_{GEN}-#Delta#phi_{RECO}) [rads]");
	UncuttableFake2_Dimuon_Opening_Angle_Residual->GetYaxis()->SetTitle("Events / 0.02 rad");

	UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle->GetYaxis()->SetTitle("Residual #Delta#phi Between Dimuon (#Delta#phi_{GEN}-#Delta#phi_{RECO}) [rads]");
	UncuttableFake2_Dimuon_opening_Angle_Residual_vs_GENangle->GetXaxis()->SetTitle("GEN #Delta#phi [rads]");
	...
	UncuttableFake1_GEN_deltaR_Between_Dimuons->GetXaxis()->SetTitle("#Delta R Between GEN Dimuons");
	UncuttableFake1_GEN_deltaR_Between_Dimuons->GetYaxis()->SetTitle("Events / 0.02");

	UncuttableFake1_RECO_deltaR_Between_Dimuons->GetXaxis()->SetTitle("#Delta R Between RECO Dimuons");
	UncuttableFake1_RECO_deltaR_Between_Dimuons->GetYaxis()->SetTitle("Events / 0.02");

	UncuttableFake1_deltaR_Between_Dimuons_Residual->GetXaxis()->SetTitle("Residual #Delta R Between Dimuon (#Delta R_{GEN}-#Delta R_{RECO})");
	UncuttableFake1_deltaR_Between_Dimuons_Residual->GetYaxis()->SetTitle("Events / 0.02");

	UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetYaxis()->SetTitle("Residual #Delta R Between Dimuon (#Delta R_{GEN}-#Delta R_{RECO})");
	UncuttableFake1_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetXaxis()->SetTitle("GEN #Delta R");

	UncuttableFake2_GEN_deltaR_Between_Dimuons->GetXaxis()->SetTitle("#Delta R Between GEN Dimuons");
	UncuttableFake2_GEN_deltaR_Between_Dimuons->GetYaxis()->SetTitle("Events / 0.02");

	UncuttableFake2_RECO_deltaR_Between_Dimuons->GetXaxis()->SetTitle("#Delta R Between RECO Dimuons");
	UncuttableFake2_RECO_deltaR_Between_Dimuons->GetYaxis()->SetTitle("Events / 0.02");

	UncuttableFake2_deltaR_Between_Dimuons_Residual->GetXaxis()->SetTitle("Residual #Delta R Between Dimuon (#Delta R_{GEN}-#Delta R_{RECO})");
	UncuttableFake2_deltaR_Between_Dimuons_Residual->GetYaxis()->SetTitle("Events / 0.02");

	UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetYaxis()->SetTitle("Residual #Delta R Between Dimuon (#Delta R_{GEN}-#Delta R_{RECO})");
	UncuttableFake2_deltaR_Between_Dimuons_Residual_vs_GENdeltaR->GetXaxis()->SetTitle("GEN #Delta R");
	...
	UncuttableFake1_GEN_Dimuon_vertex_r->GetXaxis()->SetTitle("GEN Vertex Position R [cm]");
	UncuttableFake1_GEN_Dimuon_vertex_r->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake1_RECO_Dimuon_vertex_r->GetXaxis()->SetTitle("RECO Vertex Position R [cm]");
	UncuttableFake1_RECO_Dimuon_vertex_r->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake1_Dimuon_vertex_r_Residual->GetXaxis()->SetTitle("Vertex Position R Residual (GEN-RECO) [cm]");
	UncuttableFake1_Dimuon_vertex_r_Residual->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN->GetYaxis()->SetTitle("Vertex Position R Residual (GEN-RECO) [cm]");
	UncuttableFake1_Dimuon_vertex_r_Residual_vs_GEN->GetXaxis()->SetTitle("GEN Vertex Position R [cm]");

	UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->GetXaxis()->SetTitle("GEN Vertex Position R [cm]");

	UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->GetXaxis()->SetTitle("RECO Vertex Position R [cm]");

	UncuttableFake1_GEN_Dimuon_vertex_z->GetXaxis()->SetTitle("GEN Vertex Position Z [cm]");
	UncuttableFake1_GEN_Dimuon_vertex_z->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake1_RECO_Dimuon_vertex_z->GetXaxis()->SetTitle("RECO Vertex Position Z [cm]");
	UncuttableFake1_RECO_Dimuon_vertex_z->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake1_Dimuon_vertex_z_Residual->GetXaxis()->SetTitle("Vertex Position Z Residual (GEN-RECO) [cm]");
	UncuttableFake1_Dimuon_vertex_z_Residual->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN->GetYaxis()->SetTitle("Vertex Position Z Residual (GEN-RECO) [cm]");
	UncuttableFake1_Dimuon_vertex_z_Residual_vs_GEN->GetXaxis()->SetTitle("GEN Vertex Position Z [cm]");

	UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->GetXaxis()->SetTitle("GEN Vertex Position Z [cm]");

	UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->GetXaxis()->SetTitle("RECO Vertex Position Z [cm]");



	UncuttableFake2_GEN_Dimuon_vertex_r->GetXaxis()->SetTitle("GEN Vertex Position R [cm]");
	UncuttableFake2_GEN_Dimuon_vertex_r->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake2_RECO_Dimuon_vertex_r->GetXaxis()->SetTitle("RECO Vertex Position R [cm]");
	UncuttableFake2_RECO_Dimuon_vertex_r->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake2_Dimuon_vertex_r_Residual->GetXaxis()->SetTitle("Vertex Position R Residual (GEN-RECO) [cm]");
	UncuttableFake2_Dimuon_vertex_r_Residual->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN->GetYaxis()->SetTitle("Vertex Position R Residual (GEN-RECO) [cm]");
	UncuttableFake2_Dimuon_vertex_r_Residual_vs_GEN->GetXaxis()->SetTitle("GEN Vertex Position R [cm]");

	UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->GetXaxis()->SetTitle("GEN Vertex Position R [cm]");

	UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->GetXaxis()->SetTitle("RECO Vertex Position R [cm]");

	UncuttableFake2_GEN_Dimuon_vertex_z->GetXaxis()->SetTitle("GEN Vertex Position Z [cm]");
	UncuttableFake2_GEN_Dimuon_vertex_z->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake2_RECO_Dimuon_vertex_z->GetXaxis()->SetTitle("RECO Vertex Position Z [cm]");
	UncuttableFake2_RECO_Dimuon_vertex_z->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake2_Dimuon_vertex_z_Residual->GetXaxis()->SetTitle("Vertex Position Z Residual (GEN-RECO) [cm]");
	UncuttableFake2_Dimuon_vertex_z_Residual->GetYaxis()->SetTitle("Events / 0.02 [cm]");

	UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN->GetYaxis()->SetTitle("Vertex Position Z Residual (GEN-RECO) [cm]");
	UncuttableFake2_Dimuon_vertex_z_Residual_vs_GEN->GetXaxis()->SetTitle("GEN Vertex Position Z [cm]");

	UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->GetXaxis()->SetTitle("GEN Vertex Position Z [cm]");

	UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->GetYaxis()->SetTitle("Dimuon L_{XY} Residual [cm]");
	UncuttableFake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->GetXaxis()->SetTitle("RECO Vertex Position Z [cm]");
	...
	/*
	   Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta_vs_Lxy->GetXaxis()->SetTitle("#eta_{GEN}");
	   Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta_vs_Lxy->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	   Uncuttable_Fake_dimuon1_EtaResidual_vs_Eta_vs_Lxy->GetZaxis()->SetTitle("GEN L_{XY} [cm]");
	   Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta_vs_Lxy->GetXaxis()->SetTitle("#eta_{GEN}");
	   Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta_vs_Lxy->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	   Uncuttable_Fake_dimuon2_EtaResidual_vs_Eta_vs_Lxy->GetZaxis()->SetTitle("GEN L_{XY} [cm]");
	   Real_dimuon1_EtaResidual_vs_Eta_vs_Lxy->GetXaxis()->SetTitle("#eta_{GEN}");
	   Real_dimuon1_EtaResidual_vs_Eta_vs_Lxy->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	   Real_dimuon1_EtaResidual_vs_Eta_vs_Lxy->GetZaxis()->SetTitle("GEN L_{XY} [cm]");
	   Real_dimuon2_EtaResidual_vs_Eta_vs_Lxy->GetXaxis()->SetTitle("#eta_{GEN}");
	   Real_dimuon2_EtaResidual_vs_Eta_vs_Lxy->GetYaxis()->SetTitle("#eta_{GEN}-#eta_{RECO}");
	   Real_dimuon2_EtaResidual_vs_Eta_vs_Lxy->GetZaxis()->SetTitle("GEN L_{XY} [cm]");
	   */
}
