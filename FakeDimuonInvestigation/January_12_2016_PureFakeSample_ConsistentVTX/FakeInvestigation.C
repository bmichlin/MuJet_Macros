...
//Eta residuals
TH1F *Fake_dimuon1_EtaResidual = new TH1F("Fake_dimuon1_EtaResidual", "Fake_dimuon1_EtaResidual", 100, -1, 1);
TH1F *Fake_dimuon2_EtaResidual = new TH1F("Fake_dimuon2_EtaResidual", "Fake_dimuon2_EtaResidual", 100, -1, 1);

TH2F *Fake_dimuon1_EtaResidual_vs_Eta = new TH2F("Fake_dimuon1_EtaResidual_vs_Eta", "Fake_dimuon1_EtaResidual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Fake_dimuon2_EtaResidual_vs_Eta = new TH2F("Fake_dimuon2_EtaResidual_vs_Eta", "Fake_dimuon2_EtaResidual_vs_Eta",500, -5, 5, 100, -1, 1);

TH2F *Real_dimuon1_EtaResidual_vs_Eta = new TH2F("Real_dimuon1_EtaResidual_vs_Eta", "Real_dimuon1_EtaResidual_vs_Eta",500, -5, 5, 100, -1, 1);
TH2F *Real_dimuon2_EtaResidual_vs_Eta = new TH2F("Real_dimuon2_EtaResidual_vs_Eta", "Real_dimuon2_EtaResidual_vs_Eta",500, -5, 5, 100, -1, 1);
TH1F *Real_dimuon1_EtaResidual = new TH1F("Real_dimuon1_EtaResidual", "Real_dimuon1_EtaResidual", 100, -1, 1);
TH1F *Real_dimuon2_EtaResidual = new TH1F("Real_dimuon2_EtaResidual", "Real_dimuon2_EtaResidual", 100, -1, 1);

TH2F *Fake_dimuon1_EtaResidual_vs_Lxy = new TH2F("Fake_dimuon1_EtaResidual_vs_Lxy", "Fake_dimuon1_EtaResidual_vs_Lxy", 150, 0, 30, 100, -1, 1);
TH2F *Fake_dimuon2_EtaResidual_vs_Lxy = new TH2F("Fake_dimuon2_EtaResidual_vs_Lxy", "Fake_dimuon2_EtaResidual_vs_Lxy",150, 0, 30, 100, -1, 1);

TH2F *Real_dimuon1_EtaResidual_vs_Lxy = new TH2F("Real_dimuon1_EtaResidual_vs_Lxy", "Real_dimuon1_EtaResidual_vs_Lxy",150, 0, 30, 100, -1, 1);
TH2F *Real_dimuon2_EtaResidual_vs_Lxy = new TH2F("Real_dimuon2_EtaResidual_vs_Lxy", "Real_dimuon2_EtaResidual_vs_Lxy",150, 0, 30, 100, -1, 1);
...
TH1F *Real_Muon_00_Eta_Residual = new TH1F("Real_Muon_00_Eta_Residual", "Real_Muon_00_Eta_Residual", 100, -1, 1);
TH1F *Real_Muon_01_Eta_Residual = new TH1F("Real_Muon_01_Eta_Residual", "Real_Muon_01_Eta_Residual", 100, -1, 1);
TH1F *Real_Muon_10_Eta_Residual = new TH1F("Real_Muon_10_Eta_Residual", "Real_Muon_10_Eta_Residual", 100, -1, 1);
TH1F *Real_Muon_11_Eta_Residual = new TH1F("Real_Muon_11_Eta_Residual", "Real_Muon_11_Eta_Residual", 100, -1, 1);

TH1F *Fake_Muon_00_Eta_Residual = new TH1F("Fake_Muon_00_Eta_Residual", "Fake_Muon_00_Eta_Residual", 100, -1, 1);
TH1F *Fake_Muon_01_Eta_Residual = new TH1F("Fake_Muon_01_Eta_Residual", "Fake_Muon_01_Eta_Residual", 100, -1, 1);
TH1F *Fake_Muon_10_Eta_Residual = new TH1F("Fake_Muon_10_Eta_Residual", "Fake_Muon_10_Eta_Residual", 100, -1, 1);
TH1F *Fake_Muon_11_Eta_Residual = new TH1F("Fake_Muon_11_Eta_Residual", "Fake_Muon_11_Eta_Residual", 100, -1, 1);
...
TH2F *Real_Muon_00_Eta_Residual_vs_Eta = new TH2F("Real_Muon_00_Eta_Residual_vs_Eta", "Real_Muon_00_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Real_Muon_01_Eta_Residual_vs_Eta = new TH2F("Real_Muon_01_Eta_Residual_vs_Eta", "Real_Muon_01_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Real_Muon_10_Eta_Residual_vs_Eta = new TH2F("Real_Muon_10_Eta_Residual_vs_Eta", "Real_Muon_10_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Real_Muon_11_Eta_Residual_vs_Eta = new TH2F("Real_Muon_11_Eta_Residual_vs_Eta", "Real_Muon_11_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);

TH2F *Fake_Muon_00_Eta_Residual_vs_Eta = new TH2F("Fake_Muon_00_Eta_Residual_vs_Eta", "Fake_Muon_00_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Fake_Muon_01_Eta_Residual_vs_Eta = new TH2F("Fake_Muon_01_Eta_Residual_vs_Eta", "Fake_Muon_01_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Fake_Muon_10_Eta_Residual_vs_Eta = new TH2F("Fake_Muon_10_Eta_Residual_vs_Eta", "Fake_Muon_10_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
TH2F *Fake_Muon_11_Eta_Residual_vs_Eta = new TH2F("Fake_Muon_11_Eta_Residual_vs_Eta", "Fake_Muon_11_Eta_Residual_vs_Eta", 500, -5, 5, 100, -1, 1);
...
void efficiency_hitrecovery(TString fileName){
		...
		for(int k=0;k<t->GetEntries();k++){
			...
			if(triggerFlag_std > 0 && triggerFlag_lxy > 0){
				...
				if(MatchRECOtoGENdimuons(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi, diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
					...
					Real_dimuon1_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
					Real_dimuon1_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
					Real_dimuon1_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
					Real_dimuon1_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
					Real_dimuon1_Reco_MassCompatability->Fill(diMuonC_ConsistentVtx_m,diMuonF_ConsistentVtx_m);
					...
					Real_dimuon2_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
					Real_dimuon2_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
					Real_dimuon2_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
					Real_dimuon2_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
					...
					//2Dim distributions
					Real_dimuon1_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);
					Real_dimuon1_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy);
					Real_dimuon1_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
					Real_dimuon1_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
					Real_dimuon1_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
					Real_dimuon1_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
					Real_dimuon1_Reco_MassCompatability->Fill(diMuonF_ConsistentVtx_m,diMuonF_ConsistentVtx_m);

					Real_dimuon2_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);
					Real_dimuon2_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);
					Real_dimuon2_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
					Real_dimuon2_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
					Real_dimuon2_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
					Real_dimuon2_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
				...
				if(fabs(genA0_Lxy)>=5.0 || fabs(genA0_Lz)>=34.5 || fabs(genA1_Lxy)>=5.0 || fabs(genA1_Lz)>=34.5 ){ //We only want to perform this loop on a very pure sample of fakes.  Set to 5.0 instead of 4.4. 
					...
					if(MatchRECOtoGENdimuons(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi, diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi) == 0){ //diMuonC -> A0, diMuonF -> A1
						if(fabs(genA0_Lxy)>=5.0 || fabs(genA0_Lz)>=34.5){ //A0 is the fake and has match diMuonC
							...
							if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_Lxy > -800) Fake_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);
							if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_phi > -800) Fake_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);
							...
							if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_phi > -800) Fake_dimuon1_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);

							if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_Lxy > -800) Fake_dimuon1_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);

							//eta
							Fake_dimuon1_EtaResidual->Fill(genA0_eta - diMuonC_ConsistentVtx_eta);
							Fake_dimuon1_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonC_ConsistentVtx_eta);
							Fake_dimuon1_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonC_ConsistentVtx_eta);

							//phi
							Fake_dimuon1_PhiResidual->Fill(genA0_phi - diMuonC_ConsistentVtx_phi);
							Fake_dimuon1_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonC_ConsistentVtx_phi);
							Fake_dimuon1_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonC_ConsistentVtx_phi);

							//Lxy
							Fake_dimuon1_LxyResidual->Fill(genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
							Fake_dimuon1_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);

							//Vertex
							Fake1_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
							Fake1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							Fake1_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));                       
							Fake1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							Fake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
							Fake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy), genA0_Lxy - diMuonC_ConsistentVtx_Lxy);                               

							Fake1_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
							Fake1_RECO_Dimuon_vertex_z->Fill(diMuonC_ConsistentVtx_vz);
							Fake1_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonC_ConsistentVtx_vz);
							Fake1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonC_ConsistentVtx_vz);
							Fake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
							Fake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_ConsistentVtx_vz, genA0_Lxy - diMuonC_ConsistentVtx_Lxy);
						...
						if(fabs(genA1_Lxy)>=5.0 || fabs(genA1_Lz)>=34.5){ //A1 is the fake and has match diMuonF
							...
							if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_Lxy > -800) Fake_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy);
							if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_phi > -800) Fake_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);
							...
							if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_phi > -800) Fake_dimuon2_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);

							if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_Lxy > -800) Fake_dimuon2_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy);

							//eta
							Fake_dimuon2_EtaResidual->Fill(genA1_eta - diMuonF_ConsistentVtx_eta);
							Fake_dimuon2_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonF_ConsistentVtx_eta);
							Fake_dimuon2_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonF_ConsistentVtx_eta);

							//phi
							Fake_dimuon2_PhiResidual->Fill(genA1_phi - diMuonF_ConsistentVtx_phi);
							Fake_dimuon2_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonF_ConsistentVtx_phi);
							Fake_dimuon2_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonF_ConsistentVtx_phi);

							//Lxy
							Fake_dimuon2_LxyResidual->Fill(genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
							Fake_dimuon2_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

							//Vertex
							Fake2_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
							Fake2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							Fake2_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							Fake2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							Fake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
							Fake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy), genA1_Lxy - diMuonF_ConsistentVtx_Lxy);

							Fake2_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
							Fake2_RECO_Dimuon_vertex_z->Fill(diMuonF_ConsistentVtx_vz);
							Fake2_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonF_ConsistentVtx_vz);
							Fake2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonF_ConsistentVtx_vz);
							Fake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
							Fake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_ConsistentVtx_vz, genA1_Lxy - diMuonF_ConsistentVtx_Lxy);
						...
						if(fabs(genA0_Lxy)>=5.0 || fabs(genA0_Lz)>=34.5){ //A0 is the fake and has match diMuonF
							...
							//RECO Distributions for fake dimuon 1 (diMuonF)
							if(diMuonF_ConsistentVtx_Lxy > -800) Fake_dimuon1_Reco_Lxy->Fill(diMuonF_ConsistentVtx_Lxy);
							if(diMuonF_ConsistentVtx_eta > -800) Fake_dimuon1_Reco_Eta->Fill(diMuonF_ConsistentVtx_eta);
							if(diMuonF_ConsistentVtx_phi > -800) Fake_dimuon1_Reco_Phi->Fill(diMuonF_ConsistentVtx_phi);
							if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800) Fake_dimuon1_Reco_pT->Fill(sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
							if(diMuonF_ConsistentVtx_px > -800 && diMuonF_ConsistentVtx_py > -800 && diMuonF_ConsistentVtx_Lxy > -800) Fake_dimuon1_Reco_pT_vs_Lxy->Fill(diMuonF_ConsistentVtx_Lxy, sqrt(diMuonF_ConsistentVtx_px*diMuonF_ConsistentVtx_px+diMuonF_ConsistentVtx_py*diMuonF_ConsistentVtx_py));
							if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_phi > -800) Fake_dimuon1_Reco_Eta_vs_Phi->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_phi);

							if(diMuonF_ConsistentVtx_eta > -800 && diMuonF_ConsistentVtx_Lxy > -800) Fake_dimuon1_Reco_Eta_vs_Lxy->Fill(diMuonF_ConsistentVtx_eta, diMuonF_ConsistentVtx_Lxy);

							//eta
							Fake_dimuon1_EtaResidual->Fill(genA0_eta - diMuonF_ConsistentVtx_eta);
							Fake_dimuon1_EtaResidual_vs_Eta->Fill(genA0_eta, genA0_eta - diMuonF_ConsistentVtx_eta);
							Fake_dimuon1_EtaResidual_vs_Lxy->Fill(genA0_Lxy, genA0_eta - diMuonF_ConsistentVtx_eta);

							//phi
							Fake_dimuon1_PhiResidual->Fill(genA0_phi - diMuonF_ConsistentVtx_phi);
							Fake_dimuon1_PhiResidual_vs_Phi->Fill(genA0_phi, genA0_phi - diMuonF_ConsistentVtx_phi);
							Fake_dimuon1_PhiResidual_vs_Lxy->Fill(genA0_Lxy, genA0_phi - diMuonF_ConsistentVtx_phi);

							//Lxy
							Fake_dimuon1_LxyResidual->Fill(genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
							Fake_dimuon1_LxyResidual_vs_Lxy->Fill(genA0_Lxy, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);

							//Vertex
							Fake1_GEN_Dimuon_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy));
							Fake1_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							Fake1_Dimuon_vertex_r_Residual->Fill( sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							Fake1_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy) - sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy));
							Fake1_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA0Mu0_vx*genA0Mu0_vx + genA0Mu0_vy*genA0Mu0_vy), genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
							Fake1_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonF_ConsistentVtx_vx*diMuonF_ConsistentVtx_vx + diMuonF_ConsistentVtx_vy*diMuonF_ConsistentVtx_vy), genA0_Lxy - diMuonF_ConsistentVtx_Lxy);

							Fake1_GEN_Dimuon_vertex_z->Fill(genA0Mu0_vz);
							Fake1_RECO_Dimuon_vertex_z->Fill(diMuonF_ConsistentVtx_vz);
							Fake1_Dimuon_vertex_z_Residual->Fill(genA0Mu0_vz - diMuonF_ConsistentVtx_vz);
							Fake1_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA0Mu0_vz, genA0Mu0_vz - diMuonF_ConsistentVtx_vz);
							Fake1_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA0Mu0_vz, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
							Fake1_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonF_ConsistentVtx_vz, genA0_Lxy - diMuonF_ConsistentVtx_Lxy);
						...
						if(fabs(genA1_Lxy)>=5.0 || fabs(genA1_Lz)>=34.5){ //A1 is the fake and has match diMuonC
							...
							//RECO Distributions for fake dimuon 1 (diMuonC)
							if(diMuonC_ConsistentVtx_Lxy > -800) Fake_dimuon2_Reco_Lxy->Fill(diMuonC_ConsistentVtx_Lxy);
							if(diMuonC_ConsistentVtx_eta > -800) Fake_dimuon2_Reco_Eta->Fill(diMuonC_ConsistentVtx_eta);
							if(diMuonC_ConsistentVtx_phi > -800) Fake_dimuon2_Reco_Phi->Fill(diMuonC_ConsistentVtx_phi);
							if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800) Fake_dimuon2_Reco_pT->Fill(sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
							if(diMuonC_ConsistentVtx_px > -800 && diMuonC_ConsistentVtx_py > -800 && diMuonC_ConsistentVtx_Lxy > -800) Fake_dimuon2_Reco_pT_vs_Lxy->Fill(diMuonC_ConsistentVtx_Lxy, sqrt(diMuonC_ConsistentVtx_px*diMuonC_ConsistentVtx_px+diMuonC_ConsistentVtx_py*diMuonC_ConsistentVtx_py));
							if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_phi > -800) Fake_dimuon2_Reco_Eta_vs_Phi->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_phi);

							if(diMuonC_ConsistentVtx_eta > -800 && diMuonC_ConsistentVtx_Lxy > -800) Fake_dimuon2_Reco_Eta_vs_Lxy->Fill(diMuonC_ConsistentVtx_eta, diMuonC_ConsistentVtx_Lxy);

							//eta
							Fake_dimuon2_EtaResidual->Fill(genA1_eta - diMuonC_ConsistentVtx_eta);
							Fake_dimuon2_EtaResidual_vs_Eta->Fill(genA1_eta, genA1_eta - diMuonC_ConsistentVtx_eta);
							Fake_dimuon2_EtaResidual_vs_Lxy->Fill(genA1_Lxy, genA1_eta - diMuonC_ConsistentVtx_eta);

							//phi
							Fake_dimuon2_PhiResidual->Fill(genA1_phi - diMuonC_ConsistentVtx_phi);
							Fake_dimuon2_PhiResidual_vs_Phi->Fill(genA1_phi, genA1_phi - diMuonC_ConsistentVtx_phi);
							Fake_dimuon2_PhiResidual_vs_Lxy->Fill(genA1_Lxy, genA1_phi - diMuonC_ConsistentVtx_phi);

							//Lxy
							Fake_dimuon2_LxyResidual->Fill(genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
							Fake_dimuon2_LxyResidual_vs_Lxy->Fill(genA1_Lxy, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);

							//Vertex
							Fake2_GEN_Dimuon_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy));
							Fake2_RECO_Dimuon_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							Fake2_Dimuon_vertex_r_Residual->Fill( sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							Fake2_Dimuon_vertex_r_Residual_vs_GEN->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy) - sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy));
							Fake2_Dimuon_Lxy_Residual_vs_GEN_vertex_r->Fill(sqrt(genA1Mu0_vx*genA1Mu0_vx + genA1Mu0_vy*genA1Mu0_vy), genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
							Fake2_Dimuon_Lxy_Residual_vs_RECO_vertex_r->Fill(sqrt(diMuonC_ConsistentVtx_vx*diMuonC_ConsistentVtx_vx + diMuonC_ConsistentVtx_vy*diMuonC_ConsistentVtx_vy), genA1_Lxy - diMuonC_ConsistentVtx_Lxy);

							Fake2_GEN_Dimuon_vertex_z->Fill(genA1Mu0_vz);
							Fake2_RECO_Dimuon_vertex_z->Fill(diMuonC_ConsistentVtx_vz);
							Fake2_Dimuon_vertex_z_Residual->Fill(genA1Mu0_vz - diMuonC_ConsistentVtx_vz);
							Fake2_Dimuon_vertex_z_Residual_vs_GEN->Fill(genA1Mu0_vz, genA1Mu0_vz - diMuonC_ConsistentVtx_vz);
							Fake2_Dimuon_Lxy_Residual_vs_GEN_vertex_z->Fill(genA1Mu0_vz, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
							Fake2_Dimuon_Lxy_Residual_vs_RECO_vertex_z->Fill(diMuonC_ConsistentVtx_vz, genA1_Lxy - diMuonC_ConsistentVtx_Lxy);
					...
					Fake_RECO_Dimuon_Opening_Angle->Fill(My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
					Fake_Dimuon_Opening_Angle_Residual->Fill(My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
					Fake_Dimuon_opening_Angle_Residual_vs_GENangle->Fill(My_dPhi(genA0_phi,genA1_phi), My_dPhi(genA0_phi,genA1_phi)-My_dPhi(diMuonC_ConsistentVtx_phi,diMuonF_ConsistentVtx_phi));
	...
	if(uncuttableFakeCounter != 0) std::cout << "Fake rate (#Fakes/#Events): " << std::setprecision(25) << (double)uncuttableFakeCounter/ev_all << std::endl;
