...
//=========  (Mon Aug  1 18:39:46 2016) by ROOT version6.02/05
   ...
   Double_t divide_num_1D_A0_LZ_by_den_1D_A0_LZ_fx3003[7] = {
   2,
   6,
   10,
   14,
   ...
   38,
   42};
   Double_t divide_num_1D_A0_LZ_by_den_1D_A0_LZ_fy3003[7] = {
   0.9259259,
   0.78125,
   0.7142857,
   0.5,
   ...
   1,
   1};
   Double_t divide_num_1D_A0_LZ_by_den_1D_A0_LZ_felx3003[7] = {
   2,
   2,
   2,
   2,
   ...
   2,
   2};
   Double_t divide_num_1D_A0_LZ_by_den_1D_A0_LZ_fely3003[7] = {
   0.03450175,
   0.09781244,
   0.2599379,
   0.3146989,
   ...
   0.8413447,
   0.8413447};
   Double_t divide_num_1D_A0_LZ_by_den_1D_A0_LZ_fehx3003[7] = {
   2,
   2,
   2,
   2,
   ...
   2,
   2};
   Double_t divide_num_1D_A0_LZ_by_den_1D_A0_LZ_fehy3003[7] = {
   0.02522518,
   0.07694025,
   0.182129,
   0.3146989,
   ...
   Double_t divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fx3004[8] = {
   2,
   6,
   10,
   14,
   ...
   30,
   38};
   Double_t divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fy3004[8] = {
   0.8039216,
   0.8,
   0.6666667,
   0.5,
   ...
   1,
   1};
   Double_t divide_num_1D_A1_LZ_by_den_1D_A1_LZ_felx3004[8] = {
   2,
   2,
   2,
   2,
   ...
   2,
   2};
   Double_t divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fely3004[8] = {
   0.04737422,
   0.1301189,
   0.1624937,
   0.1951821,
   ...
   0.6016845,
   0.8413447};
   Double_t divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fehx3004[8] = {
   2,
   2,
   2,
   2,
   ...
   2,
   2};
   Double_t divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fehy3004[8] = {
   0.04071474,
   0.09312246,
   0.1355138,
   0.1951821,
   ...
   0,
   0};
   grae = new TGraphAsymmErrors(8,divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fx3004,divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fy3004,divide_num_1D_A1_LZ_by_den_1D_A1_LZ_felx3004,divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fehx3004,divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fely3004,divide_num_1D_A1_LZ_by_den_1D_A1_LZ_fehy3004);
   ...
   Graph_divide_num_1D_A1_LZ_by_den_1D_A1_LZ3004->SetMinimum(0.07452078);
   Graph_divide_num_1D_A1_LZ_by_den_1D_A1_LZ3004->SetMaximum(1.084134);
