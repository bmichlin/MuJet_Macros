...
TH1F *etaGEN_DimuonF_NoCuts = new TH1F("etaGEN_DimuonF_NoCuts", "etaGEN_DimuonF_NoCuts", 500, -5, 5);
TH1F *etaGEN_DimuonF_4SelMu8 = new TH1F("etaGEN_DimuonF_4SelMu8", "etaGEN_DimuonF_4SelMu8", 500, -5, 5);
TH1F *etaGEN_DimuonF_isVertexOK = new TH1F("etaGEN_DimuonF_isVertexOK", "etaGEN_DimuonF_isVertexOK", 500, -5, 5);
TH1F *etaGEN_DimuonF_is2MuJets = new TH1F("etaGEN_DimuonF_is2MuJets", "etaGEN_DimuonF_is2MuJets", 500, -5, 5);
TH1F *etaGEN_DimuonF_is2DiMuons = new TH1F("etaGEN_DimuonF_is2DiMuons", "etaGEN_DimuonF_is2DiMuons", 500, -5, 5);
TH1F *etaGEN_DimuonF_is2DiMuonsFittedVtxOK = new TH1F("etaGEN_DimuonF_is2DiMuonsFittedVtxOK", "etaGEN_DimuonF_is2DiMuonsFittedVtxOK", 500, -5, 5);

TH1F *etaGEN_DimuonC_NoCuts = new TH1F("etaGEN_DimuonC_NoCuts", "etaGEN_DimuonC_NoCuts", 500, -5, 5);
TH1F *etaGEN_DimuonC_4SelMu8 = new TH1F("etaGEN_DimuonC_4SelMu8", "etaGEN_DimuonC_4SelMu8", 500, -5, 5);
TH1F *etaGEN_DimuonC_isVertexOK = new TH1F("etaGEN_DimuonC_isVertexOK", "etaGEN_DimuonC_isVertexOK", 500, -5, 5);
TH1F *etaGEN_DimuonC_is2MuJets = new TH1F("etaGEN_DimuonC_is2MuJets", "etaGEN_DimuonC_is2MuJets", 500, -5, 5);
TH1F *etaGEN_DimuonC_is2DiMuons = new TH1F("etaGEN_DimuonC_is2DiMuons", "etaGEN_DimuonC_is2DiMuons", 500, -5, 5);
TH1F *etaGEN_DimuonC_is2DiMuonsFittedVtxOK = new TH1F("etaGEN_DimuonC_is2DiMuonsFittedVtxOK", "etaGEN_DimuonC_is2DiMuonsFittedVtxOK", 500, -5, 5);
...
void efficiency_hitrecovery(const std::vector<std::string>& dirNames){
	...
	while ((chEl=(TChainElement*)next())) {
		...
		for(int k=0;k<t->GetEntries();k++){
			...
			etaGEN_DimuonC_NoCuts->Fill(genA0_eta);
			etaGEN_DimuonF_NoCuts->Fill(genA1_eta);
			if(is4SelMu8 == false) continue;
			//--------------------
			//Match Dimuons RECO-GEN
			int etaResult = MatchRECOtoGENdimuons(diMuonC_FittedVtx_eta, diMuonC_FittedVtx_phi, diMuonF_FittedVtx_eta, diMuonF_FittedVtx_phi, genA0_eta, genA0_phi, genA1_eta, genA0_phi);
			//if etaResult == 0; diMuonC -> A0, diMuonF -> A1 
			//if etaResult == 1; diMuonC -> A1, diMuonF -> A0
			//--------------------
			if(etaResult == 0){
				etaGEN_DimuonC_4SelMu8->Fill(genA0_eta);
				etaGEN_DimuonF_4SelMu8->Fill(genA1_eta);
			}else{
				etaGEN_DimuonC_4SelMu8->Fill(genA1_eta);
				etaGEN_DimuonF_4SelMu8->Fill(genA0_eta);
			}
			if(isVertexOK== false) continue;
			if(etaResult == 0){
				etaGEN_DimuonC_isVertexOK->Fill(genA0_eta);
				etaGEN_DimuonF_isVertexOK->Fill(genA1_eta);
			}else{
				etaGEN_DimuonC_isVertexOK->Fill(genA1_eta);
				etaGEN_DimuonF_isVertexOK->Fill(genA0_eta);
			}

			if(is2MuJets== false) continue;
			if(etaResult == 0){
				etaGEN_DimuonC_is2MuJets->Fill(genA0_eta);
				etaGEN_DimuonF_is2MuJets->Fill(genA1_eta);
			}else{
				etaGEN_DimuonC_is2MuJets->Fill(genA1_eta);
				etaGEN_DimuonF_is2MuJets->Fill(genA0_eta);
			}

			if(is2DiMuons== false) continue;
			if(etaResult == 0){
				etaGEN_DimuonC_is2DiMuons->Fill(genA0_eta);
				etaGEN_DimuonF_is2DiMuons->Fill(genA1_eta);
			}else{
				etaGEN_DimuonC_is2DiMuons->Fill(genA1_eta);
				etaGEN_DimuonF_is2DiMuons->Fill(genA0_eta);
			}
			if(is2DiMuonsFittedVtxOK){
				if(etaResult == 0){
					etaGEN_DimuonC_is2DiMuonsFittedVtxOK->Fill(genA0_eta);
					etaGEN_DimuonF_is2DiMuonsFittedVtxOK->Fill(genA1_eta);
				}else{
					etaGEN_DimuonC_is2DiMuonsFittedVtxOK->Fill(genA1_eta);
					etaGEN_DimuonF_is2DiMuonsFittedVtxOK->Fill(genA0_eta);
				}
 //{{{
...
//}}}
				...
				if(diMuonF_m1_FittedVtx_hitpix_l3inc==1||diMuonF_m2_FittedVtx_hitpix_l3inc==1){ 
					...
					if(matchResult == 0){
						...
						PassWithNoPHRDimuonF_Gen_Dimuon_Opening_Angle->Fill(My_dPhi(genA1_phi,genA1_phi));
						PassWithNoPHRDimuonF_Gen_MassPlot->Fill(genA1_m,genA1_m);
