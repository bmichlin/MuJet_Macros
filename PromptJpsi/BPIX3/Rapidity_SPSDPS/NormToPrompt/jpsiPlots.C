...
void makePlotsPretty(){
	...
	t1_data_jpsi_DeltaRapidityC->Scale(14.0/t1_data_np_regionC_dimuon1_lxy->Integral()); //14.0 is number of prompt events from ABCD method
	...
	t1_sps_jpsi_DeltaRapidity->Scale(14.0/t1_sps_jpsi_DeltaRapidity->Integral());
	t1_dps_jpsi_DeltaRapidity->Scale(14.0/t1_dps_jpsi_DeltaRapidity->Integral());
