...
#Get the publish location
	...
	send "$GRIDPASSWORD\r";
	expect "$ ";
	send "crab resubmit -d /afs/cern.ch/work/b/bmichlin/public/withTAMU/DarkSUSYSampleGeneration/CMSSW_7_1_15_patch1/src/MuJetAnalysis/GEN_SIM/crab_projects/crab_DarkSUSY_mH_125_mGammaD_$mGammaD\_cT_$CT\_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MCRUN2_71_V1_v1 \r";
	expect "$ ";
	set timeout 86400;
	expect "$ ";
	send "cd .\r";
